...
as “derived from the RSA Data Security, Inc. MD4 Message-Digest Algorithm” in
all material mentioning or referencing the derived work. RSA Data Security, Inc.
...
void MD4Update(MD4_CTX *context, const unsigned char *input,
