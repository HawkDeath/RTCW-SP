...
//#define	MAX_MSGLEN				16384		// max length
//of a message, which may
...
//----(SA)	heh, whoops.  we've been talking to id servers since we got a
//connection... #define	UPDATE_SERVER_NAME	"update.quake3arena.com" #define
//MASTER_SERVER_NAME	"master.quake3arena.com" #define
//AUTHORIZE_SERVER_NAME	"authorize.quake3arena.com"
//----(SA)	yes, these are bogus addresses.  I'm guessing these will be set
//to a machine at Activision or id eventually
...
// TTimo
// show_bug.cgi?id=447
// int Sys_ShellExecute(char *op, char *file, qboolean doexit, char *params,
// char *dir);	//----(SA) added
