...
.data
    ...
    .align 4 Ljmptab :.long Lcase0,
    Lcase1, Lcase2, Lcase3.long Lcase4, Lcase5, Lcase6,
    Lcase7
...
#define val 4
        ...
        .globl C(Invert24To16) C(Invert24To16)
    :
...
%
        ...
        // bk000422 - warning: missing prefix `*' in absolute indirect address,
        // maybe misassembled! bk001129 - fix from Andrew Henderson, was:
        // Ljmptab(,%eax,4)
        jmp
        *
        Ljmptab(, % eax, 4)
