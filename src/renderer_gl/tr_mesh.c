...
void R_AddMD3Surfaces(trRefEntity_t *ent) {
  ...
  for (i = 0; i < header->numSurfaces; i++) {
    ...
    //texture are duplicated 		and the 'lids' rendered with polygonoffset shader
    //parm over the top of the open eyes.  this gives 		minimal overdraw/alpha
    //blending/texture use without breaking the model and causing seams
