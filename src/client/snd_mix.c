...
===================
*/
void S_SetVoiceAmplitudeFrom16(const sfx_t *sc, int sampleOffset, int count,
                               int entnum) {
...
===================
*/
void S_SetVoiceAmplitudeFromADPCM(const sfx_t *sc, int sampleOffset, int count,
                                  int entnum) {
  int data, i, sfx_count;
  sndBuffer *chunk;
  short *samples;
...
===================
*/
void S_SetVoiceAmplitudeFromWavelet(const sfx_t *sc, int sampleOffset,
                                    int count, int entnum) {
  int data, i, sfx_count;
  sndBuffer *chunk;
  short *samples;
...
===================
*/
void S_SetVoiceAmplitudeFromMuLaw(const sfx_t *sc, int sampleOffset, int count,
                                  int entnum) {
  int data, i, sfx_count;
  sndBuffer *chunk;
  byte *samples;
    ...
    for (si = 0, ss = streamingSounds; si < MAX_STREAMING_SOUNDS; si++, ss++) {
      ...
      if (s_rawend[si] >= s_paintedtime) {
        ...
        for (i = s_paintedtime; i < stop; i++) {
          ...
          // DAJ					paintbuffer[i-s_paintedtime].left +=
