...
void IN_MLookDown(void) { kb[KB_MLOOK].active = qtrue; }
...
void IN_ButtonDown(void) { IN_KeyDown(&kb[KB_BUTTONS1]); }
...
============
*/
void CL_ClearKeys(void) { memset(kb, 0, sizeof(kb)); }
