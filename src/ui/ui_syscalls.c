...
void trap_GetRenderconfig(renderconfig_t *renderconfig) {
  syscall(UI_GETRENDERCONFIG, renderconfig);
}
...
void trap_LAN_SaveCachedServers() { syscall(UI_LAN_SAVECACHEDSERVERS); }

void trap_LAN_LoadCachedServers() { syscall(UI_LAN_LOADCACHEDSERVERS); }
