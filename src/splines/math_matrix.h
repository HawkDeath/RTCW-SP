...
public:
  ...
  mat3_t(const float xx, const float xy, const float xz, const float yx,
         const float yy, const float yz, const float zx, const float zy,
         const float zz);
...
ID_INLINE mat3_t::mat3_t(const float xx, const float xy, const float xz,
...
ID_INLINE void InverseMultiply(const mat3_t &inv, const mat3_t &b,
                               mat3_t &dst) {
