...
================
*/
template <class type> inline idList<type>::idList(int granularity) {
...
================
*/
template <class type> inline idList<type>::~idList() { Clear(); }
...
================
*/
template <class type> inline void idList<type>::Clear(void) {
  if (m_list) {
    delete[] m_list;
  }
...
================
*/
template <class type> inline int idList<type>::Num(void) { return m_num; }
...
================
*/
template <class type> inline void idList<type>::SetNum(int num) {
  assert(num >= 0);
  if (num > m_size) {
...
================
*/
template <class type> inline void idList<type>::Condense(void) {
  if (m_list) {
    if (m_num) {
      Resize(m_num);
    } else {
...
================
*/
template <class type> inline int idList<type>::Size(void) { return m_size; }
...
================
*/
template <class type> inline void idList<type>::Resize(int size) {
  type *temp;
  int i;
...
================
*/
template <class type> inline type idList<type>::operator[](int index) const {
  assert(index >= 0);
  assert(index < m_num);
