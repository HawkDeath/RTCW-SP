...
void VectorRotate3Origin(vec3_c vIn, vec3_c vRotation, vec3_c vOrigin,
                         vec3_p out);
...
void RotatePointAroundVector(vec3_p dst, vec3_c dir, vec3_c point,
                             float degrees);
...
void MatrixInverseMultiply(mat3_c in1, mat3_c in2,
...
const char *Com_StringContains(const char *str1, const char *str2,
                               int casesensitive);
...
qboolean GetVectorForMapEntityKey(const mapEntity_t *ent, const char *key,
                                  idVec3 &vec);
