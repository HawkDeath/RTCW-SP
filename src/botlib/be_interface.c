...
int BotExportTest(int parm0, char *parm1, vec3_t parm2, vec3_t parm3) {
  ...
  //					AAS_AreaTravelTimeToGoalArea(area, origin,
  //botlibglobals.goalareanum, TFL_DEFAULT)); 		botimport.Print(PRT_MESSAGE, "test
  //rj from 703 to 716\n"); 		AAS_Reachability_WeaponJump(703, 716); 	} //end if*/
  ...
  */
  ...
  if (parm0 & 2) {
    ...
    reachnum = BotGetReachabilityToGoal(
        origin, newarea, -1, lastgoalareanum, lastareanum, avoidreach,
  ...
  */
  ...
  if (bsptrace.fraction < 1.0)
  {
          ...
          AAS_DrawPlaneCross(bsptrace.endpos,
                                                                  ...
                                                                  bsptrace.plane.dist
  + bsptrace.exp_dist, bsptrace.plane.type, LINECOLOR_GREEN); if (trace.ent)
          {
                  ent = &(*aasworld).entities[trace.ent];
                  AAS_ShowBoundingBox(ent->origin, ent->mins, ent->maxs);
          } //end if
  ...
  if (bsptrace.fraction < 1.0)
  {
          AAS_DrawPlaneCross(bsptrace.endpos,
                                                                  bsptrace.plane.normal,
                                                                  bsptrace.plane.dist,//
  + bsptrace.exp_dist, bsptrace.plane.type, LINECOLOR_RED); if (bsptrace.ent)
          {
