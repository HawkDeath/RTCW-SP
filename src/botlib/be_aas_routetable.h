...
typedef struct {
  ...
  //	int							numLocalRoutes;
  //	aas_rt_route_t				*localRoutes;		// the list of routes
  //to all other local areas

  //	int							numParentRoutes;
  //	unsigned char				*parentRoutes;		// reachability to
  //each other parent, as an offset from our first reachability
  ...
  //	int							numRouteIndexes;
  //	unsigned short int			*routeIndexes;		// each parentLink
  //has a list within here, which
