...
FT_ERRORDEF(FT_Err_Invalid_Version, 0x0037, "invalid FreeType version")
FT_ERRORDEF(FT_Err_Lower_Module_Version, 0x0038, "module version is too low")

FT_ERRORDEF(FT_Err_Too_Many_Drivers, 0x0040, "too many modules")
FT_ERRORDEF(FT_Err_Too_Many_Extensions, 0x0041, "too many extensions")
...
FT_ERRORDEF(FT_Err_Invalid_Composite, 0x0070, "invalid composite glyph")
FT_ERRORDEF(FT_Err_Too_Many_Hints, 0x0071, "too many hints")
