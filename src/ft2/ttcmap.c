...
static FT_UInt code_to_index0(TT_CMapTable *charmap, FT_ULong char_code);
static FT_UInt code_to_index2(TT_CMapTable *charmap, FT_ULong char_code);
static FT_UInt code_to_index4(TT_CMapTable *charmap, FT_ULong char_code);
static FT_UInt code_to_index6(TT_CMapTable *charmap, FT_ULong char_code);
...
/*                                                                       */
LOCAL_FUNC
FT_Error TT_CharMap_Load(TT_Face face, TT_CMapTable *cmap, FT_Stream stream) {
  FT_Error error;
  FT_Memory memory;
  ...
  case 2:
    ...
    if (ALLOC_ARRAY(cmap2->subHeaders, num_SH + 1, TT_CMap2SubHeader) ||
  ...
  case 4:
    ...
    if (ALLOC_ARRAY(cmap4->segments, num_Seg, TT_CMap4Segment) ||
  ...
  case 6:
    ...
    if (ALLOC_ARRAY(cmap6->glyphIdArray, cmap6->entryCount, FT_Short) ||
        ACCESS_Frame(l * 2L)) {
      goto Fail;
    }
...
/*                                                                       */
static FT_UInt code_to_index0(TT_CMapTable *cmap, FT_ULong charCode) {
...
/*    Glyph index into the glyphs array.  0 if the glyph does not exist. */
/*                                                                       */
static FT_UInt code_to_index2(TT_CMapTable *cmap, FT_ULong charCode) {
...
/*    Glyph index into the glyphs array.  0 if the glyph does not exist. */
/*                                                                       */
static FT_UInt code_to_index4(TT_CMapTable *cmap, FT_ULong charCode) {
...
/*    Glyph index into the glyphs array.  0 if the glyph does not exist. */
/*                                                                       */
static FT_UInt code_to_index6(TT_CMapTable *cmap, FT_ULong charCode) {
  TT_CMap6 *cmap6;
  FT_UInt result = 0;
