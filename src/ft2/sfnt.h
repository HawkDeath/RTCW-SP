...
typedef FT_Module_Interface (*SFNT_Get_Interface_Func)(FT_Module module,
...
/*                                                                       */
typedef FT_Error (*TT_Load_SFNT_Header_Func)(TT_Face face, FT_Stream stream,
                                             FT_Long face_index,
                                             SFNT_Header *sfnt);
...
/*                                                                       */
typedef FT_Error (*TT_Load_SBit_Image_Func)(TT_Face face, FT_Int x_ppem,
                                            FT_Int y_ppem, FT_UInt glyph_index,
                                            FT_UInt load_flags,
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
typedef FT_Error (*TT_Get_PS_Name_Func)(TT_Face face, FT_UInt index,
                                        FT_String **PSname);
...
/*    released.                                                          */
/*                                                                       */
typedef FT_Error (*TT_CharMap_Load_Func)(TT_Face face, TT_CMapTable *cmap,
                                         FT_Stream input);
