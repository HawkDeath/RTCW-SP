...
static const FT_Long ft_square_roots[63] = {
    1L,         1L,         2L,         3L,         4L,          5L,
    8L,         11L,        16L,        22L,        32L,         45L,
    64L,        90L,        128L,       181L,       256L,        362L,
    512L,       724L,       1024L,      1448L,      2048L,       2896L,
    4096L,      5892L,      8192L,      11585L,     16384L,      23170L,
    32768L,     46340L,
    ...
    33554432L,  47453132L,  67108864L,  94906265L,  134217728L,  189812531L,
    268435456L, 379625062L, 536870912L, 759250125L, 1073741824L, 1518500250L,
    2147483647L};
...
/*                                                                       */
FT_EXPORT_FUNC(FT_Long) FT_MulDiv(FT_Long a, FT_Long b, FT_Long c) {
  FT_Int s;
  ...
  return s * (c > 0 ? ((FT_Int64)a * b + (c >> 1)) / c : 0x7FFFFFFFL);
}
...
/*    difference.                                                        */
/*                                                                       */
FT_EXPORT_FUNC(FT_Long) FT_MulFix(FT_Long a, FT_Long b) {
  FT_Int s;
...
/*                                                                       */
FT_EXPORT_FUNC(FT_Long) FT_DivFix(FT_Long a, FT_Long b) {
  FT_Int32 s;
  FT_UInt32 q;
...
/*                                                                       */
FT_EXPORT_FUNC(void) FT_Add64(FT_Int64 *x, FT_Int64 *y, FT_Int64 *z) {
...
/*                                                                       */
FT_EXPORT_FUNC(void) FT_MulTo64(FT_Int32 x, FT_Int32 y, FT_Int64 *z) {
  FT_Int32 s;
...
/*                                                                       */
FT_EXPORT_FUNC(FT_Int32) FT_Div64by32(FT_Int64 *x, FT_Int32 y) {
  FT_Int32 s;
  FT_UInt32 q, r, i, lo;
...
FT_EXPORT_FUNC(FT_Int32) FT_Sqrt64(FT_Int64 *l) {
  ...
  if ((FT_Int32)l->hi < 0 || (l->hi == 0 && l->lo == 0)) {
    return 0;
  }
