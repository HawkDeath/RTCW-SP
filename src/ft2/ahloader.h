...
LOCAL_DEF
FT_Error AH_GlyphLoader_New(FT_Memory memory, AH_GlyphLoader **aloader);
...
LOCAL_DEF
FT_Error AH_GlyphLoader_Check_Points(AH_GlyphLoader *loader, FT_UInt n_points,
                                     FT_UInt n_contours);

LOCAL_DEF
FT_Error AH_GlyphLoader_Check_Subglyphs(AH_GlyphLoader *loader, FT_UInt n_subs);
