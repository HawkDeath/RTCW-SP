 ...
 *
 * desc:		text commands typed in at the local console, or executed by a
 * key binding
 *
 */
...
static void CG_InventoryDown_f(void) { cg.showItems = qtrue; }
...
void CG_FreeCamera(int camNum) { cameraInuse[camNum] = qfalse; }
...
static consoleCommand_t commands[] = {
    ...
    //	{ "+zoom", CG_ZoomDown_f },		// (SA) zoom moved to a wbutton so server
    //can determine weapon firing based on zoom status 	{ "-zoom", CG_ZoomUp_f },
    {"zoomin", CG_ZoomIn_f},
