...
typedef enum {
  ...
  CG_R_GETSKINMODEL, // client allowed to view what the .skin loaded so they can
                     // set their model appropriately
  ...
  CG_SNAPVECTOR,
  CG_REMOVECOMMAND,
  //	CG_R_LIGHTFORPOINT,	// not currently used (sorry, trying to keep
  //CG_MEMSET @ 100)
  ...
  CG_CIN_SETEXTENTS,
  CG_R_REMAP_SHADER,
  //	CG_S_ADDREALLOOPINGSOUND,	// not currently used (sorry, trying to
  //keep CG_MEMSET @ 100)
