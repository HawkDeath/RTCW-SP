...
//#define	RELIABLE_COMMANDS_SINGLE	256		// need more for
//loadgame situations

#define RELIABLE_COMMANDS_CHARS                                                \
  384 // we can scale this down from the max of 1024, since not all commands are
      // going to use that many chars
