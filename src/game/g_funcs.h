{"Info_SetValueForKey_Big", (byte *)Info_SetValueForKey_Big},
    ...
    {"va", (byte *)va}, {"Q_strcasecmp", (byte *)Q_strcasecmp},
    {"Q_strncasecmp", (byte *)Q_strncasecmp},
    {"Com_sprintf", (byte *)Com_sprintf}, {"Q_CleanStr", (byte *)Q_CleanStr},
    {"Q_PrintStrlen", (byte *)Q_PrintStrlen}, {"Q_strcat", (byte *)Q_strcat},
    {"Q_strupr", (byte *)Q_strupr}, {"Q_strlwr", (byte *)Q_strlwr},
    {"Q_stricmp", (byte *)Q_stricmp}, {"Q_strncmp", (byte *)Q_strncmp},
    {"Q_stricmpn", (byte *)Q_stricmpn}, {"Q_strncpyz", (byte *)Q_strncpyz},
    ...
    {"Q_isprint", (byte *)Q_isprint}, {"Parse3DMatrix", (byte *)Parse3DMatrix},
    ...
    {"ShortSwap", (byte *)ShortSwap}, {"LittleFloat", (byte *)LittleFloat},
    {"BigFloat", (byte *)BigFloat}, {"LittleLong64", (byte *)LittleLong64},
    {"BigLong64", (byte *)BigLong64}, {"LittleLong", (byte *)LittleLong},
    {"BigLong", (byte *)BigLong}, {"LittleShort", (byte *)LittleShort},
    {"BigShort", (byte *)BigShort}, {"COM_BitClear", (byte *)COM_BitClear},
    ...
    {"COM_SkipPath", (byte *)COM_SkipPath}, {"Com_Clamp", (byte *)Com_Clamp},
    {"VectorDistance", (byte *)VectorDistance},
    {"AxisToAngles", (byte *)AxisToAngles}, {"vectoyaw", (byte *)vectoyaw},
    ...
    {"MatrixMultiply", (byte *)MatrixMultiply}, {"Q_log2", (byte *)Q_log2},
    ...
    {"_VectorCopy", (byte *)_VectorCopy}, {"_VectorAdd", (byte *)_VectorAdd},
    {"_VectorSubtract", (byte *)_VectorSubtract},
    {"_DotProduct", (byte *)_DotProduct}, {"_VectorMA", (byte *)_VectorMA},
    ...
    {"AngleMod", (byte *)AngleMod}, {"AnglesSubtract", (byte *)AnglesSubtract},
    {"AngleSubtract", (byte *)AngleSubtract}, {"LerpAngle", (byte *)LerpAngle},
    {"Q_fabs", (byte *)Q_fabs}, {"Q_rsqrt", (byte *)Q_rsqrt},
    ...
    {"Q_rand", (byte *)Q_rand}, {"FireWeapon", (byte *)FireWeapon},
    ...
    {"LogAccuracyHit", (byte *)LogAccuracyHit}, {"AddLean", (byte *)AddLean},
    ...
    {"Tesla_Fire", (byte *)Tesla_Fire}, {"Cross_Fire", (byte *)Cross_Fire},
    ...
    {"Weapon_Knife", (byte *)Weapon_Knife}, {"DebugLine", (byte *)DebugLine},
    ...
    {"G_KillBox", (byte *)G_KillBox}, {"G_TempEntity", (byte *)G_TempEntity},
    ...
    {"G_PickTarget", (byte *)G_PickTarget}, {"G_Find", (byte *)G_Find},
    ...
    {"gas_think", (byte *)gas_think}, {"gas_touch", (byte *)gas_touch},
    ...
    {"hurt_use", (byte *)hurt_use}, {"hurt_think", (byte *)hurt_think},
    ...
    {"multi_wait", (byte *)multi_wait}, {"InitTrigger", (byte *)InitTrigger},
    ...
    {"TramCarUse", (byte *)TramCarUse}, {"Tramcar_die", (byte *)Tramcar_die},
    {"Reached_Tramcar", (byte *)Reached_Tramcar},
    {"GetNextTrack", (byte *)GetNextTrack}, {"Calc_Roll", (byte *)Calc_Roll},
    ...
    {"trap_GeneticParentsAndChildSelection",
     (byte *)trap_GeneticParentsAndChildSelection},
    ...
    {"trap_BotInterbreedGoalFuzzyLogic",
     (byte *)trap_BotInterbreedGoalFuzzyLogic},
    ...
    {"trap_BotItemGoalInVisButNotVisible",
     (byte *)trap_BotItemGoalInVisButNotVisible},
    ...
    {"trap_AAS_FindAttackSpotWithinRange",
     (byte *)trap_AAS_FindAttackSpotWithinRange},
    ...
    {"trap_AAS_AreaTravelTimeToGoalArea",
     (byte *)trap_AAS_AreaTravelTimeToGoalArea},
    ...
    {"trap_AAS_PresenceTypeBoundingBox",
     (byte *)trap_AAS_PresenceTypeBoundingBox},
    ...
    {"trap_Argv", (byte *)trap_Argv}, {"trap_Argc", (byte *)trap_Argc},
    {"trap_Milliseconds", (byte *)trap_Milliseconds},
    {"trap_Endgame", (byte *)trap_Endgame}, {"trap_Error", (byte *)trap_Error},
    {"trap_Printf", (byte *)trap_Printf}, {"PASSFLOAT", (byte *)PASSFLOAT},
    {"dllEntry", (byte *)dllEntry}, {"ConsoleCommand", (byte *)ConsoleCommand},
    ...
    {"G_NewString", (byte *)G_NewString}, {"G_CallSpawn", (byte *)G_CallSpawn},
    {"G_SpawnVector", (byte *)G_SpawnVector},
    {"G_SpawnInt", (byte *)G_SpawnInt}, {"G_SpawnFloat", (byte *)G_SpawnFloat},
    ...
    {"G_ScriptAction_EntityScriptName",
     (byte *)G_ScriptAction_EntityScriptName},
    ...
    {"G_Script_EventMatch_StringEqual",
     (byte *)G_Script_EventMatch_StringEqual},
    ...
    {"G_LoadGame", (byte *)G_LoadGame}, {"G_SaveGame", (byte *)G_SaveGame},
    {"G_Save_DateStr", (byte *)G_Save_DateStr},
    {"G_Save_TimeStr", (byte *)G_Save_TimeStr}, {"ReadTime", (byte *)ReadTime},
    {"WriteTime", (byte *)WriteTime}, {"ReadCastState", (byte *)ReadCastState},
    {"WriteCastState", (byte *)WriteCastState},
    {"ReadEntity", (byte *)ReadEntity}, {"WriteEntity", (byte *)WriteEntity},
    {"ReadClient", (byte *)ReadClient}, {"WriteClient", (byte *)WriteClient},
    {"G_Save_Decode", (byte *)G_Save_Decode},
    {"G_Save_Encode", (byte *)G_Save_Encode}, {"ReadField", (byte *)ReadField},
    {"WriteField2", (byte *)WriteField2}, {"WriteField1", (byte *)WriteField1},
    ...
    {"DropToFloorG", (byte *)DropToFloorG}, {"G_Activate", (byte *)G_Activate},
    ...
    {"Static_Pain", (byte *)Static_Pain}, {"Use_Static", (byte *)Use_Static},
    ...
    {"FuncBatsActivate", (byte *)FuncBatsActivate}, {"BatDie", (byte *)BatDie},
    ...
    {"G_RunCrowbar", (byte *)G_RunCrowbar}, {"G_RunSpit", (byte *)G_RunSpit},
    ...
    {"M_think", (byte *)M_think}, {"Concussive_fx", (byte *)Concussive_fx},
    ...
    {"SP_mg42", (byte *)SP_mg42}, {"mg42_spawn", (byte *)mg42_spawn},
    {"mg42_use", (byte *)mg42_use}, {"mg42_die", (byte *)mg42_die},
    {"mg42_think", (byte *)mg42_think}, {"Flak_Animate", (byte *)Flak_Animate},
    {"mg42_track", (byte *)mg42_track}, {"mg42_touch", (byte *)mg42_touch},
    ...
    {"flakPuff", (byte *)flakPuff}, {"SP_Bubbles", (byte *)SP_Bubbles},
    {"SP_Snow", (byte *)SP_Snow}, {"snow_think", (byte *)snow_think},
    {"snowInPVS", (byte *)snowInPVS}, {"SP_dlight", (byte *)SP_dlight},
    ...
    {"G_RunFrame", (byte *)G_RunFrame}, {"G_RunThink", (byte *)G_RunThink},
    ...
    {"LogExit", (byte *)LogExit}, {"G_LogPrintf", (byte *)G_LogPrintf},
    ...
    {"SendScoreboardMessageToAllClients",
     (byte *)SendScoreboardMessageToAllClients},
    ...
    {"Com_Printf", (byte *)Com_Printf}, {"Com_Error", (byte *)Com_Error},
    ...
    {"G_Error", (byte *)G_Error}, {"G_DPrintf", (byte *)G_DPrintf},
    {"G_Printf", (byte *)G_Printf}, {"G_RunItem", (byte *)G_RunItem},
    ...
    {"Pickup_Ammo", (byte *)Pickup_Ammo}, {"Add_Ammo", (byte *)Add_Ammo},
    ...
    {"CanDamage", (byte *)CanDamage}, {"G_Damage", (byte *)G_Damage},
    {"G_ArmorDamage", (byte *)G_ArmorDamage},
    {"IsHeadShot", (byte *)IsHeadShot},
    {"IsHeadShotWeapon", (byte *)IsHeadShotWeapon},
    {"CheckArmor", (byte *)CheckArmor}, {"player_die", (byte *)player_die},
    {"body_die", (byte *)body_die}, {"GibEntity", (byte *)GibEntity},
    {"GibHead", (byte *)GibHead}, {"LookAtKiller", (byte *)LookAtKiller},
    {"TossClientItems", (byte *)TossClientItems},
    {"AddScore", (byte *)AddScore}, {"ClientCommand", (byte *)ClientCommand},
    ...
    {"Cmd_GameCommand_f", (byte *)Cmd_GameCommand_f}, {"G_Say", (byte *)G_Say},
    {"G_SayTo", (byte *)G_SayTo},
    {"Cmd_FollowCycle_f", (byte *)Cmd_FollowCycle_f},
    {"Cmd_Follow_f", (byte *)Cmd_Follow_f}, {"Cmd_Team_f", (byte *)Cmd_Team_f},
    {"StopFollowing", (byte *)StopFollowing},
    {"SetWolfData", (byte *)SetWolfData}, {"SetTeam", (byte *)SetTeam},
    ...
    {"ClientSpawn", (byte *)ClientSpawn}, {"ClientBegin", (byte *)ClientBegin},
    ...
    {"PickTeam", (byte *)PickTeam}, {"respawn", (byte *)respawn},
    {"reinforce", (byte *)reinforce}, {"limbo", (byte *)limbo},
    ...
    {"BG_PlayerStateToEntityStateExtraPolate",
     (byte *)BG_PlayerStateToEntityStateExtraPolate},
    {"BG_PlayerStateToEntityState", (byte *)BG_PlayerStateToEntityState},
    {"BG_AddPredictableEventToPlayerstate",
     (byte *)BG_AddPredictableEventToPlayerstate},
    ...
    {"AICast_ScriptAction_AIScriptName",
     (byte *)AICast_ScriptAction_AIScriptName},
    {"AICast_ScriptAction_EntityScriptName",
     (byte *)AICast_ScriptAction_EntityScriptName},
    ...
    {"AICast_ScriptAction_StopCamBlack",
     (byte *)AICast_ScriptAction_StopCamBlack},
    {"AICast_ScriptAction_StartCamBlack",
     (byte *)AICast_ScriptAction_StartCamBlack},
    ...
    {"AICast_ScriptAction_FoundSecret",
     (byte *)AICast_ScriptAction_FoundSecret},
    {"AICast_ScriptAction_ChangeLevel",
     (byte *)AICast_ScriptAction_ChangeLevel},
    ...
    {"AICast_ScriptAction_SavePersistant",
     (byte *)AICast_ScriptAction_SavePersistant},
    ...
    {"AICast_ScriptAction_ResetScript",
     (byte *)AICast_ScriptAction_ResetScript},
    {"AICast_ScriptAction_FaceTargetAngles",
     (byte *)AICast_ScriptAction_FaceTargetAngles},
    ...
    {"AICast_ScriptAction_ObjectiveMet",
     (byte *)AICast_ScriptAction_ObjectiveMet},
    {"AICast_ScriptAction_ObjectivesNeeded",
     (byte *)AICast_ScriptAction_ObjectivesNeeded},
    {"AICast_ScriptAction_MissionFailed",
     (byte *)AICast_ScriptAction_MissionFailed},
    ...
    {"AICast_ScriptAction_SelectWeapon",
     (byte *)AICast_ScriptAction_SelectWeapon},
    {"AICast_ScriptAction_SuggestWeapon",
     (byte *)AICast_ScriptAction_SuggestWeapon},
    ...
    {"AICast_ScriptAction_AbortIfLoadgame",
     (byte *)AICast_ScriptAction_AbortIfLoadgame},
    {"AICast_ScriptAction_CrouchToCast",
     (byte *)AICast_ScriptAction_CrouchToCast},
    ...
    {"AIFunc_Heinrich_SpawnSpiritsStart",
     (byte *)AIFunc_Heinrich_SpawnSpiritsStart},
    ...
    {"AICast_CanMoveWhileFiringWeapon",
     (byte *)AICast_CanMoveWhileFiringWeapon},
    ...
    {"AICast_Die", (byte *)AICast_Die}, {"AICast_Pain", (byte *)AICast_Pain},
    ...
    {"SP_ai_loper", (byte *)SP_ai_loper}, {"SP_ai_venom", (byte *)SP_ai_venom},
