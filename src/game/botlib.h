...
#define BLERR_CANNOTLOADITEMCONFIG 29 // BotSetupLibrary: cannot load item
                                      // config
...
typedef struct aas_export_s {
  ...
  int (*AAS_FindAttackSpotWithinRange)(int srcnum, int rangenum, int enemynum,
                                       ...
                                       float *outpos);
  qboolean (*AAS_GetRouteFirstVisPos)(vec3_t srcpos, vec3_t destpos,
                                      int travelflags, vec3_t retpos);
  void (*AAS_SetAASBlockingEntity)(vec3_t absmin, vec3_t absmax,
                                   qboolean blocking);
  // done.
...
"basedir"					""
l_utils.c			Quake2 base directory
"gamedir"					""
l_utils.c			Quake2 game directory
"cddir"						""
l_utils.c			Quake2 CD directory

"autolaunchbspc"			"0"
be_aas_load.c		automatically launch (Win)BSPC
"log"						"0"
l_log.c				enable/disable creating a log file "maxclients"
"4"					be_interface.c		maximum number
of clients "maxentities"				"1024"
be_interface.c		maximum number of entities
...
"sv_waterfriction"			"1"
be_aas_move.c		water friction
"sv_watergravity"			"400"
be_aas_move.c		gravity in water "sv_maxvelocity"
"300"				be_aas_move.c		maximum velocity
"sv_maxwalkvelocity"		"300"
be_aas_move.c		maximum walk velocity
"sv_maxcrouchvelocity"		"100"
be_aas_move.c		maximum crouch velocity "sv_maxswimvelocity"
"150"				be_aas_move.c		maximum swim velocity
"sv_walkaccelerate"			"10"
...
"sv_maxbarrier"				"32"
be_aas_move.c		maximum barrier height
"sv_maxsteepness"			"0.7"
be_aas_move.c		maximum floor steepness "sv_jumpvel"
"270"				be_aas_move.c		jump z velocity
"sv_maxwaterjump"			"20"
be_aas_move.c		maximum waterjump height
