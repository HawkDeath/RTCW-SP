...
AICharacterDefaults_t aiDefaults[NUM_CHARACTERS] = {
    ...
    {"Soldier",
     ...
     {
         "infantrySightPlayer", "infantryAttackPlayer", "infantryOrders",
         "infantryDeath",
         "infantrySilentDeath", //----(SA)	added
         "infantryFlameDeath",  //----(SA)	added
         "infantryPain",
         "infantryStay",   // stay - you're told to stay put
         "infantryFollow", // follow - go with ordering player ("i'm with you"
                           // rather than "yes sir!")
     ...
     BBOX_SMALL,
     {32, 48},                              // bbox, crouch/stand height
     AIFL_CATCH_GRENADE | AIFL_STAND_IDLE2, // flags
     NULL,
     NULL,
     NULL, // special attack routine
     NULL, // looping sound
     AISTATE_RELAXED},
    ...
    {"American",
     ...
     {
         "americanSightPlayer", "americanAttackPlayer", "americanOrders",
         "americanDeath",
         "americanSilentDeath", //----(SA)	added
         "americanFlameDeath",  //----(SA)	added
         "americanPain",
         "americanStay",   // stay - you're told to stay put
         "americanFollow", // follow - go with ordering player ("i'm with you"
                           // rather than "yes sir!")
    ...
    {"Zombie",
     ...
     {
         "zombieSightPlayer", "zombieAttackPlayer", "zombieOrders",
         "zombieDeath",
         "zombieSilentDeath", //----(SA)	added
         "zombieFlameDeath",  //----(SA)	added
         "zombiePain",
         "sound/weapons/melee/fstatck.wav", // stay - you're told to stay put
         "sound/weapons/melee/fstmiss.wav", // follow - go with ordering player
                                            // ("i'm with you" rather than "yes
                                            // sir!")
     ...
     AIFunc_ZombieFlameAttackStart,
     AIFunc_ZombieAttack2Start,
    ...
    {"WarriorZombie",
     ...
     {
         "warzombieSightPlayer", "warzombieAttackPlayer", "warzombieOrders",
         "warzombieDeath",
     ...
     BBOX_SMALL,
     {10, 48}, // very low defense position
     AIFL_NO_RELOAD,
     AIFunc_WarriorZombieMeleeStart,
     /*AIFunc_WarriorZombieSightStart*/ NULL,
    ...
    {"Venom",
     ...
     {
         "venomSightPlayer", "venomAttackPlayer", "venomOrders", "venomDeath",
         "venomSilentDeath", //----(SA)	added
         "venomFlameDeath",  //----(SA)	added
         "venomPain",
         "venomStay",       // stay - you're told to stay put
         "venomFollow",     // follow - go with ordering player ("i'm with you"
                            // rather than "yes sir!")
     ...
     BBOX_SMALL,
     {32, 48},
     AIFL_NO_FLAME_DAMAGE | AIFL_WALKFORWARD |
         AIFL_NO_RELOAD, // |AIFL_NO_HEADSHOT_DMG,
     NULL,
     NULL,
     NULL,
     NULL,
    ...
    {"Loper",
     ...
     {
         "loperSightPlayer", "loperAttackPlayer", "loperOrders", "loperDeath",
         "loperSilentDeath", //----(SA)	added
         "loperFlameDeath",  //----(SA)	added
         "loperPain",
         "loperAttack2Start", // stay - you're told to stay put
         "loperAttackStart", // follow - go with ordering player ("i'm with you"
                             // rather than "yes sir!")
     ...
     {/*WP_MONSTER_ATTACK1,*/ WP_MONSTER_ATTACK2, WP_MONSTER_ATTACK3},
     BBOX_LARGE,
     {32, 32}, // large is for wide characters
     AIFL_NO_RELOAD,
     NULL /*AIFunc_LoperAttack1Start*/,
     AIFunc_LoperAttack2Start,
    ...
    {"Elite Guard",
     ...
     {
         "eliteGuardSightPlayer", "eliteGuardAttackPlayer", "eliteGuardOrders",
         "eliteGuardDeath",
         "eliteGuardSilentDeath", //----(SA)	added
         "eliteGuardFlameDeath",  //----(SA)	added
         "eliteGuardPain",
         "eliteGuardStay",   // stay - you're told to stay put
         "eliteGuardFollow", // follow - go with ordering player ("i'm with you"
                             // rather than "yes sir!")
    ...
    {"Stim Soldier",
     ...
     {
         "stimSoldierSightPlayer", "stimSoldierAttackPlayer",
         "stimSoldierOrders", "stimSoldierDeath",
         "stimSoldierSilentDeath", //----(SA)	added
         "stimSoldeirFlameDeath",  //----(SA)	added
         "stimSoldierPain",
         "stimSoldierStay",       // stay - you're told to stay put
         "stimSoldierFollow",     // follow - go with ordering player ("i'm with
                                  // you" rather than "yes sir!")
     ...
     AIFL_NO_RELOAD,
     NULL,
     AIFunc_StimSoldierAttack2Start,
     NULL,
     NULL,
     AISTATE_ALERT},
    ...
    {"Stim Soldier",
     ...
     {48, 64},
     AIFL_NO_RELOAD,
     AIFunc_StimSoldierAttack1Start,
     NULL,
     NULL,
     NULL,
     AISTATE_ALERT},
    ...
    {"Stim Soldier",
     ...
     AITEAM_NAZI,
     "stim/default",
     {WP_MP40, WP_TESLA}, // no monster_attack1, since that's only used for the
                          // jumping rocket attack
     BBOX_LARGE,
     {48, 64},
     AIFL_NO_RELOAD,
     AIFunc_StimSoldierAttack1Start,
    ...
    {"Super Soldier",
     ...
     {
         "superSoldierSightPlayer", "superSoldierAttackPlayer",
         "superSoldierOrders", "superSoldierDeath",
         "superSoldierSilentDeath", //----(SA)	added
         "superSoldierFlameDeath",  //----(SA)	added
         "superSoldierPain",
         "superSoldierStay",   // stay - you're told to stay put
         "superSoldierFollow", // follow - go with ordering player ("i'm with
                               // you" rather than "yes sir!")
         "superSoldierOrdersDeny", // deny - refuse orders (doing something
                                   // else)
     },
     AITEAM_NAZI,
    ...
    {"Black Guard",
     ...
     {
         "blackGuardSightPlayer", "blackGuardAttackPlayer", "blackGuardOrders",
         "blackGuardDeath",
         "blackGuardSilentDeath", //----(SA)	added
         "blackGuardFlameDeath",  //----(SA)	added
         "blackGuardPain",
         "blackGuardStay",   // stay - you're told to stay put
         "blackGuardFollow", // follow - go with ordering player ("i'm with you"
                             // rather than "yes sir!")
         "blackGuardOrdersDeny", // deny - refuse orders (doing something else)
     },
     AITEAM_NAZI,
     "blackguard/default",
     //		{WP_MP40, WP_GRENADE_LAUNCHER, WP_MONSTER_ATTACK1},	// attack1 is melee
     //kick
    ...
    {"Protosoldier",
     ...
     {
         "protoSoldierSightPlayer", "protoSoldierAttackPlayer",
         "protoSoldierOrders", "protoSoldierDeath",
         "protoSoldierSilentDeath", //----(SA)	added
         "protoSoldierFlameDeath",  //----(SA)	added
         "protoSoldierPain",
         "protoSoldierStay",   // stay - you're told to stay put
         "protoSoldierFollow", // follow - go with ordering player ("i'm with
                               // you" rather than "yes sir!")
         "protoSoldierOrdersDeny", // deny - refuse orders (doing something
                                   // else)
     },
     AITEAM_NAZI,
     ...
     BBOX_LARGE,
     {48, 64},
     AIFL_NO_TESLA_DAMAGE | AIFL_NO_FLAME_DAMAGE | AIFL_WALKFORWARD |
         AIFL_NO_RELOAD,
     NULL,
     NULL,
     NULL,
    ...
    {"Frogman",
     ...
     {
         "frogmanSightPlayer", "frogmanAttackPlayer", "frogmanOrders",
         "frogmanDeath",
         "frogmanSilentDeath", //----(SA)	added
         "frogmanFlameDeath",  //----(SA)	added
         "frogmanPain",
         "frogmanStay",   // stay - you're told to stay put
         "frogmanFollow", // follow - go with ordering player ("i'm with you"
                          // rather than "yes sir!")
    ...
    {"Helga",
     ...
     {
         "helgaAttackPlayer", "helgaAttackPlayer", "helgaOrders", "helgaDeath",
         "helgaSilentDeath", //----(SA)	added
         "helgaFlameDeath",  //----(SA)	added
         "helgaAttackPlayer",
         "sound/weapons/melee/fstatck.wav", // stay - you're told to stay put
         "helgaFollow",     // follow - go with ordering player ("i'm with you"
                            // rather than "yes sir!")
     ...
     {WP_MONSTER_ATTACK1,
      WP_MONSTER_ATTACK2 /*,WP_MONSTER_ATTACK3*/}, // starting weapons
     BBOX_LARGE,
     {90, 90}, // bbox, crouch/stand height
    ...
    {"Heinrich",
     ...
     {
         "heinrichSightPlayer", "heinrichAttackPlayer", "heinrichOrders",
         "heinrichDeath", "heinrichSilentDeath",
         "heinrichFlameDeath", //----(SA)	added
         "heinrichPain",
         "heinrichStay",   // stay - you're told to stay put
         "heinrichFollow", // follow - go with ordering player ("i'm with you"
                           // rather than "yes sir!")
     ...
     {WP_MONSTER_ATTACK1, WP_MONSTER_ATTACK2,
      WP_MONSTER_ATTACK3}, // attack3 is given to him by scripting
     BBOX_LARGE,
     {72, 72}, // (SA) height is not exact.  just eyeballed.
...
AIChar_SetBBox
  ...
  since height isn't important for the AAS routing (whereas width is very
important)
============
*/
void AIChar_SetBBox(gentity_t *ent, cast_state_t *cs, qboolean useHeadTag) {
  ...
  if (!useHeadTag) {
  ...
  } else if (trap_GetTag(ent->s.number, "tag_head",
                         & or)) { // if not found, then just leave it
    ...
    if (bbox[1][2] > ent->client->ps.maxs[2]) {
      ...
      trap_TraceCapsule(&tr, ent->client->ps.origin, bbox[0], bbox[1],
                        ent->client->ps.origin, ent->s.number, ent->clipmask);
    }
...
============
*/
void AIChar_Death(gentity_t *ent, gentity_t *attacker, int damage,
                  int mod) { //----(SA)	added mod
  ...
  if (ent->health > GIB_HEALTH) {
    if (ent->client->ps.eFlags & EF_HEADSHOT) {
      G_AddEvent(ent, EV_GENERAL_SOUND,
                 G_SoundIndex(aiDefaults[ent->aiCharacter]
                                  .soundScripts[QUIETDEATHSOUNDSCRIPT]));
    } else {
      ...
      case MOD_FLAMETHROWER:
        G_AddEvent(
            ...
            G_SoundIndex(
                aiDefaults[ent->aiCharacter]
                    .soundScripts[FLAMEDEATHSOUNDSCRIPT])); //----(SA)	added
        break;
      default:
        G_AddEvent(
            ent, EV_GENERAL_SOUND,
            G_SoundIndex(
                aiDefaults[ent->aiCharacter].soundScripts[DEATHSOUNDSCRIPT]));
        break;
      }
    }
  }
...
int AIChar_GetPainLocation(gentity_t *ent, vec3_t point) {
  static char *painTagNames[] = {
      "tag_head",    "tag_chest",    "tag_torso",   "tag_groin", "tag_armright",
      "tag_armleft", "tag_legright", "tag_legleft", NULL,
  };
  ...
  // find a correct animation to play, based on the body orientation at previous
  // frame
...
============
*/
void AIChar_Pain(gentity_t *ent, gentity_t *attacker, int damage,
                 vec3_t point) {
...
#define STUNNED_THRESHOLD 30
  ...
  // if they are already playing another animation, we might get confused and
  // cut it off, so don't play a pain
  ...
  if (attacker->s.weapon == WP_FLAMETHROWER &&
      !(cs->aiFlags &
        AIFL_NO_FLAME_DAMAGE)) { // flames should be recognized more often,
                                 // since they stay onfire until they're dead
                                 // anyway
    painThreshold = 1;
    stunnedThreshold = 99999; // dont be stunned
  }

  // HACK: if the attacker is using the flamethrower, don't do any special pain
  // anim or sound
  ...
  if (cs->damageQuotaTime && cs->damageQuota > 0) {
    cs->damageQuota -=
        (int)((1.0 + (g_gameskill.value / GSKILL_MAX)) *
              ((float)(level.time - cs->damageQuotaTime) / 1000) *
              (7.5 + cs->attributes[ATTACK_SKILL] * 10.0));
    if (cs->damageQuota < 0) {
      cs->damageQuota = 0;
    }
  }
  ...
  if (cs->painSoundTime < level.time - 1000) {
    ...
    damage =
        (int)((float)damage *
              (1.0 + (scale * (1.0 - 0.5 * g_gameskill.value / GSKILL_MAX))));
  }

  // adjust the new damage with distance, if they are really close, scale it
  // down, to make it harder to get through the game by continually rushing the
  // enemies
  if ((attacker->s.weapon != WP_TESLA) &&
      ((dist = VectorDistance(ent->r.currentOrigin,
                              attacker->r.currentAngles)) < 384)) {
    damage -= (int)((float)damage * (1.0 - (dist / 384.0)) *
                    (0.5 + 0.5 * g_gameskill.value / GSKILL_MAX));
  }
  ...
  if (g_testPain.integer == 2 || (cs->damageQuota > painThreshold)) {
    ...
    // enemy weapon
    if (attacker->client) {
      BG_UpdateConditionValue(ent->s.number, ANIM_COND_ENEMY_WEAPON,
                              attacker->s.weapon, qtrue);
    }
    if (point) {
      // location
      BG_UpdateConditionValue(ent->s.number, ANIM_COND_IMPACT_POINT,
                              AIChar_GetPainLocation(ent, point), qtrue);
    } else {
    ...
    if (delay >= 0) {
      ...
      if (cs->bs->cur_ps.viewheight == cs->bs->cur_ps.crouchViewHeight) {
        cs->attackcrouch_time =
            level.time + (float)(cs->pauseTime - level.time) + 500;
      }
    }

    // if we didnt just play a scripted sound, then play one of the default
    // sounds
    if (cs->lastScriptSound < level.time) {
      G_AddEvent(
          ent, EV_GENERAL_SOUND,
          G_SoundIndex(
              aiDefaults[ent->aiCharacter].soundScripts[PAINSOUNDSCRIPT]));
    }
    ...
    cs->painSoundTime =
        ...
        (int)(1000 *
              (g_gameskill.value /
               GSKILL_MAX)); // add a bit more of a buffer before the next one
  }
}
...
void AIChar_Sight(gentity_t *ent, gentity_t *other, int lastSight) {
  ...
  if (!AICast_SameTeam(cs, other->s.number)) {
    if (!cs->firstSightTime || cs->firstSightTime < (level.time - 15000)) {
      // G_AddEvent( ent, EV_GENERAL_SOUND, G_SoundIndex(
      // aiDefaults[ent->aiCharacter].sightSoundScript ) );
    }
...
void AIChar_AttackSound(cast_state_t *cs) {
  ...
  // Ridah, only yell when throwing grenades every now and then, since it's not
  // very "stealthy"
  ...
  if (cs->weaponNum == WP_LUGER) {
    G_AddEvent(
        ent, EV_GENERAL_SOUND,
        G_SoundIndex(
            aiDefaults[ent->aiCharacter].soundScripts[ORDERSSOUNDSCRIPT]));
  } else {
    G_AddEvent(
        ent, EV_GENERAL_SOUND,
        G_SoundIndex(
            aiDefaults[ent->aiCharacter].soundScripts[ATTACKSOUNDSCRIPT]));
  }
}
...
void AIChar_spawn(gentity_t *ent) {
  ...
  for (i = MAX_CLIENTS, newent = &g_entities[MAX_CLIENTS]; i < MAX_GENTITIES;
       i++, newent++) {
    if (!newent->inuse) {
      continue;
    }
  ...
  for (i = 0; aiCharDefaults->weapons[i]; i++) {
    // weaponInfo.startingWeapons[(aiCharDefaults->weapons[i] / 32)] |= ( 1 <<
    // aiCharDefaults->weapons[i] ); weaponInfo.startingWeapons[0] |= ( 1 <<
    // aiCharDefaults->weapons[i] );

    COM_BitSet(weaponInfo.startingWeapons, aiCharDefaults->weapons[i]);
    if (aiCharDefaults->weapons[i] ==
        WP_GRENADE_LAUNCHER) { // give them a bunch of grenades, but not an
                               // unlimited supply
      weaponInfo
          .startingAmmo[BG_FindAmmoForWeapon(aiCharDefaults->weapons[i])] = 6;
    } else {
      weaponInfo
          .startingAmmo[BG_FindAmmoForWeapon(aiCharDefaults->weapons[i])] = 999;
    }
  }
  //
  ...
  newent = AICast_CreateCharacter(ent, aiCharDefaults->attributes, &weaponInfo,
                                  aiCharDefaults->name, ent->aiSkin,
                                  ent->aihSkin, "m", "7", "100");
  ...
  // copy any character-specific information to the new entity (like editor
  // fields, etc)
  //
  ...
  if (ent->aiTeam == AITEAM_ALLIES ||
      ent->aiTeam == AITEAM_NEUTRAL) { // friendly
  ...
  // set these values now so scripting system isn't relying on a Think having
  // been run prior to running a script
  // origin of the cast
...
soldier entity
"skin" the .skin file to use for this character (must exist in the player
characters directory, otherwise 'infantryss/default' is used) "head" the .skin
file to use for his head (must exist in the pc's dir, otherwise 'default' is
used) "ainame" name of AI
*/
/*
...
american entity
"skin" the .skin file to use for this character (must exist in the player
characters directory, otherwise 'american/default' is used) "head" the .skin
file to use for his head (must exist in the pc's dir, otherwise 'default' is
used) "ainame" name of AI
*/
...
//----------------------------------------------------------------------------------------------------------------------------
/*QUAKED ai_zombie (1 0.25 0) (-16 -16 -24) (16 16 64) TriggerSpawn NoRevive
PortalZombie zombie entity "skin" the .skin file to use for this character (must
exist in the player characters directory, otherwise 'zombie/default' is used)
"head" the .skin file to use for his head (must exist in the pc's dir, otherwise
'default' is used) "ainame" name of AI
*/
...
//----------------------------------------------------------------------------------------------------------------------------
/*QUAKED ai_warzombie (1 0.25 0) (-16 -16 -24) (16 16 64) TriggerSpawn NoRevive
PortalZombie warrior zombie entity "skin" the .skin file to use for this
character (must exist in the player characters directory, otherwise
'warrior/default' is used) "head" the .skin file to use for his head (must exist
in the pc's dir, otherwise 'default' is used) "ainame" name of AI
*/
...
venom entity
"skin" the .skin file to use for this character (must exist in the player
characters directory, otherwise 'venom/default' is used) "head" the .skin file
to use for his head (must exist in the pc's dir, otherwise 'default' is used)
"ainame" name of AI
*/
...
loper entity
"skin" the .skin file to use for this character (must exist in the player
characters directory, otherwise 'loper/default' is used) "head" the .skin file
to use for his head (must exist in the pc's dir, otherwise 'default' is used)
"ainame" name of AI
*/
...
helga entity
"skin" the .skin file to use for this character (must exist in the player
characters directory, otherwise 'helga/default' is used) "head" the .skin file
to use for his head (must exist in the pc's dir, otherwise 'default' is used)
"ainame" name of AI
*/
...
//----------------------------------------------------------------------------------------------------------------------------
/*QUAKED ai_boss_heinrich (1 0.25 0) (-32 -32 -24) (32 32 156) TriggerSpawn
NoRevive heinrich entity "skin" the .skin file to use for this character (must
exist in the player characters directory, otherwise 'helga/default' is used)
"head" the .skin file to use for his head (must exist in the pc's dir, otherwise
'default' is used) "ainame" name of AI
*/
...
"skin" the .skin file to use for this character (must exist in the player
characters directory, otherwise 'partisan/default' is used) "head" the .skin
file to use for his head (must exist in the pc's dir, otherwise 'default' is
used) "ainame" name of AI
*/
...
"skin" the .skin file to use for this character (must exist in the player
characters directory, otherwise 'civilian/default' is used) "head" the .skin
file to use for his head (must exist in the pc's dir, otherwise 'default' is
used) "ainame" name of AI
*/
...
elite guard entity
"skin" the .skin file to use for this character (must exist in the player
characters directory, otherwise 'eliteguard/default' is used) "head" the .skin
file to use for his head (must exist in the pc's dir, otherwise 'default' is
used) "ainame" name of AI
*/
...
elite guard entity
"skin" the .skin file to use for this character (must exist in the player
characters directory, otherwise 'frogman/default' is used) "head" the .skin file
to use for his head (must exist in the pc's dir, otherwise 'default' is used)
"ainame" name of AI
*/
...
//----------------------------------------------------------------------------------------------------------------------------
/*QUAKED ai_stimsoldier_dual (1 0.25 0) (-32 -32 -24) (32 32 64) TriggerSpawn
NoRevive stim soldier entity "skin" the .skin file to use for this character
(must exist in the player characters directory, otherwise 'stim/default' is
used) "head" the .skin file to use for his head (must exist in the pc's dir,
otherwise 'default' is used) "ainame" name of AI
*/
...
//----------------------------------------------------------------------------------------------------------------------------
/*QUAKED ai_stimsoldier_rocket (1 0.25 0) (-32 -32 -24) (32 32 64) TriggerSpawn
NoRevive stim soldier entity "skin" the .skin file to use for this character
(must exist in the player characters directory, otherwise 'stim/default' is
used) "head" the .skin file to use for his head (must exist in the pc's dir,
otherwise 'default' is used) "ainame" name of AI
...
//----------------------------------------------------------------------------------------------------------------------------
/*QUAKED ai_stimsoldier_tesla (1 0.25 0) (-32 -32 -24) (32 32 64) TriggerSpawn
NoRevive stim soldier entity "skin" the .skin file to use for this character
(must exist in the player characters directory, otherwise 'stim/default' is
used) "head" the .skin file to use for his head (must exist in the pc's dir,
otherwise 'default' is used) "ainame" name of AI
...
//----------------------------------------------------------------------------------------------------------------------------
/*QUAKED ai_supersoldier (1 0.25 0) (-32 -32 -24) (32 32 64) TriggerSpawn
NoRevive supersoldier entity "skin" the .skin file to use for this character
(must exist in the player characters directory, otherwise 'supersoldier/default'
is used) "head" the .skin file to use for his head (must exist in the pc's dir,
otherwise 'default' is used) "ainame" name of AI
*/
...
//----------------------------------------------------------------------------------------------------------------------------
/*QUAKED ai_protosoldier (1 0.25 0) (-32 -32 -24) (32 32 64) TriggerSpawn
NoRevive protosoldier entity "skin" the .skin file to use for this character
(must exist in the player characters directory, otherwise 'protosoldier/default'
is used) "head" the .skin file to use for his head (must exist in the pc's dir,
otherwise 'default' is used) "ainame" name of AI
*/
...
black guard entity
"skin" the .skin file to use for this character (must exist in the player
characters directory, otherwise 'blackguard/default' is used) "head" the .skin
file to use for his head (must exist in the pc's dir, otherwise 'default' is
used) "ainame" name of AI
*/
