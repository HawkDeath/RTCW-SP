...
// NOTE: weapons that share ammo (ex. colt/thompson) need to share max ammo, but
// not necessarily uses or max clip
...
// [1] = uses			-	how many 'rounds' it takes/costs to fire one
// cycle. [2] = maxclip		-	max 'rounds' in a clip. [3] = reloadTime
// -	time from start of reload until ready to fire.
...
// [6] = maxHeat		-	max active firing time before weapon 'overheats'
// (at which point the weapon will fail for a moment)
...
// ammoWarning		-	amount we give the player a 'low on ammo' warning
// (just a HUD color change or something) clipWarning		-	amount
// we give the player a 'low in clip' warning (just a HUD color change or
// something)
// maxclip2			-	allow the player to (mod/powerup) upgrade clip
// size when aplicable (luger has 8 round standard clip and 32 round snail
// magazine, for ex.)
//
//
//
...
ammotable_t ammoTable[] = {
    ...
    //...
    //	AMMO			AMT.	CLIP	TIME	DELAY
    //SHOT
    {0, 0, 0, 0, 50, 0, 0, 0,
     0}, //	WP_NONE					// 0

    {999, 0, 999, 0, 50, 200, 0, 0,
     MOD_KNIFE}, //	WP_KNIFE				// 1

    {MAX_AMMO_9MM, 1, 8, 1500, DELAY_PISTOL, 400, 0, 0,
     MOD_LUGER}, //	WP_LUGER				// 2	// NOTE: also 32
                 //round 'snail' magazine
    {MAX_AMMO_9MM, 1, 32, 2600, DELAY_LOW, 100, 0, 0,
     MOD_MP40}, //	WP_MP40					// 3
    {MAX_AMMO_MAUSER, 1, 10, 2500, DELAY_HIGH, 1200, 0, 0,
     MOD_MAUSER}, //	WP_MAUSER				// 4	// NOTE: authentic
                  //clips are 5/10/25 rounds
    {MAX_AMMO_FG42, 1, 20, 2000, DELAY_LOW, 200, 0, 0,
     MOD_FG42}, //	WP_FG42					// 5
    {15, 1, 15, 1000, DELAY_THROW, 1600, 0, 0,
     MOD_GRENADE_LAUNCHER}, //	WP_GRENADE_LAUNCHER		// 6
    {5, 1, 1, 1000, DELAY_SHOULDER, 2000, 0, 0,
     MOD_PANZERFAUST}, //	WP_PANZERFAUST			// 7
    //	{	MAX_AMMO_VENOM,	1,		500,	3000,	750,			30,		5000,	200,
    //MOD_VENOM				},	//	WP_VENOM				//
    //-
    {MAX_AMMO_VENOM, 1, 500, 3000, 750, 45, 5000, 200,
     MOD_VENOM}, //	WP_VENOM				// 8	// JPW NOTE:
                 //changed next_shot 50->45 to genlock firing to every server
                 //frame (fire rate shouldn't be framerate dependent now)
    {150, 1, 150, 1000, DELAY_LOW, 50, 0, 0,
     MOD_FLAMETHROWER}, //	WP_FLAMETHROWER			// 9
    {300, 1, 300, 1000, DELAY_LOW, 0, 0, 0,
     MOD_TESLA}, //	WP_TESLA				// 10
                 //	{	50,				1,		50,		1000,	DELAY_LOW,		1200,	0,		0,
                 //MOD_SPEARGUN			},	//	WP_SPEARGUN				//
                 //11

    //	{	999,			0,		999,	0,		50,				200,	0,		0,		MOD_KNIFE2
    //},	//	WP_KNIFE2				// 12
    {MAX_AMMO_45, 1, 8, 1500, DELAY_PISTOL, 400, 0, 0,
     MOD_COLT}, //	WP_COLT					// 13
    {MAX_AMMO_45, 1, 30, 2400, DELAY_LOW, 120, 0, 0,
     MOD_THOMPSON}, //	WP_THOMPSON				// 14	// NOTE: also 50 round drum
                    //magazine
    {MAX_AMMO_GARAND, 1, 5, 2500, DELAY_HIGH, 1200, 0, 0,
     MOD_GARAND}, //	WP_GARAND				// 15	// NOTE: always 5
                  //round clips
                  //	{	MAX_AMMO_BAR,	1,		20,		2000,	DELAY_LOW,		200,	0,		0,
                  //MOD_BAR					},	//	WP_BAR					//
                  //16
    {15, 1, 15, 1000, DELAY_THROW, 1600, 0, 0,
     MOD_GRENADE_PINEAPPLE}, //	WP_GRENADE_PINEAPPLE	// 17
    //	{	5,				1,		5,		1000,	DELAY_SHOULDER,	1200,	0,		0,
    //MOD_ROCKET_LAUNCHER		},	//	WP_ROCKET_LAUNCHER		//
    //18

    {MAX_AMMO_MAUSER, 1, 10, 3000, 0, 1700, 0, 0,
     MOD_SNIPERRIFLE}, //	WP_SNIPER_GER			// 19
    {MAX_AMMO_GARAND, 1, 5, 3000, 0, 1200, 0, 0,
     MOD_SNOOPERSCOPE}, //	WP_SNIPER_AM			// 20
    //	{	MAX_AMMO_VENOM,	10,		300,	3000,	1200,			1200,	0,		0,
    //MOD_VENOM_FULL			},	//	WP_VENOM_FULL			//
    //-
    //	{	MAX_AMMO_VENOM,	10,		300,	3000,	1000,			1000,	0,		0,
    //MOD_VENOM_FULL			},	//	WP_VENOM_FULL			//
    //21
    //	{	20,				1,		20,		1000,	DELAY_LOW,		1200,	0,		0,
    //MOD_SPEARGUN_CO2		},	//	WP_SPEARGUN_CO2			//
    //22

    {MAX_AMMO_FG42, 1, 20, 2000, DELAY_LOW, 200, 0, 0,
     MOD_FG42SCOPE}, //	WP_FG42SCOPE			// 23
                     //	{	MAX_AMMO_BAR,	1,		20,		2000,	DELAY_LOW,		90,		0,		0,
                     //MOD_BAR					},	//	WP_BAR2					//
                     //24
    {MAX_AMMO_9MM, 1, 32, 3100, DELAY_LOW, 110, 700, 300,
     MOD_STEN}, //	WP_STEN					// 25
    {MAX_AMMO_9MM, 1, 8, 1500, DELAY_PISTOL, 400, 0, 0,
     MOD_SILENCER}, //	WP_SILENCER				// 26
    {MAX_AMMO_45, 1, 8, 2700, DELAY_PISTOL, 200, 0, 0,
     MOD_AKIMBO}, //	WP_AKIMBO				// 27

    {999, 0, 999, 0, 50, 0, 0, 0,
     0}, //	WP_CLASS_SPECIAL		// 28	//	class_special
         //	{	100,			1,		100,	1000,	DELAY_PISTOL,	900,	0,		0,
         //MOD_CROSS				},	//	WP_CROSS				//
         //29
    {10, 1, 10, 1000, DELAY_THROW, 1600, 0, 0,
     MOD_DYNAMITE}, //	WP_DYNAMITE				// 30
                    //	{	10,				1,		10,		1000,	DELAY_THROW,	1600,	0,		0,
                    //MOD_DYNAMITE			},	//	WP_DYNAMITE2			//
                    //31

    // stubs for some "not-real" weapons (so they always return "yes, you have
    // enough ammo for that gauntlet", etc.)
    //	{	5,				1,		5,		1000,	DELAY_SHOULDER,	1200,	0,		0,		0
    ///*mod_prox*/			},	//	WP_PROX					//
    //32
    {999, 0, 999, 0, 50, 0, 0, 0,
     0}, //	WP_MONSTER_ATTACK1		// 33
    {999, 0, 999, 0, 50, 0, 0, 0,
     0}, //	WP_MONSTER_ATTACK2		// 34
    {999, 0, 999, 0, 50, 0, 0, 0,
     0}, //	WP_MONSTER_ATTACK3		// 35
    {999, 0, 999, 0, 50, 0, 0, 0,
     0} //	WP_GAUNTLET				// 36
};
...
int weapAlts[] = {
    ...
    //	WP_DYNAMITE			// 31 WP_DYNAMITE2	//----(SA)
    //new
};
...
gitem_t bg_itemlist
    [] = {{NULL,
           ...
           "",            // precache
           "",            // sounds
           {0, 0, 0, 0}}, // leave index 0 alone

          /*QUAKED item_clipboard (1 1 0) (-8 -8 -8) (8 8 8) SUSPENDED SPIN
          PERSISTANT "model" - model to display in the world.  defaults to
          'models/powerups/clipboard/clipboard.md3' (the clipboard laying flat
          is 'clipboard2.md3') "popup" - menu to popup.  no default since you
          won't want the same clipboard laying around. (clipboard will display a
          'put popup here' message) "notebookpage" - when clipboard is picked
          up, this page (menu) will be added to your notebook (FIXME: TODO: more
          info goes here)
          ...
          */
          {"item_clipboard",
           ...
           {"models/powerups/clipboard/clipboard.md3", 0, 0, 0, 0},
           "icons/iconh_small",
           NULL, // ammo icon
           "",
           1,
          ...
          Items the player picks up that are just used to tally a score at
          end-level "model" defaults to 'models/powerups/treasure/goldbar.md3'
          "noise" sound to play on pickup.  defaults to
          'sound/pickup/treasure/gold.wav' "message" what to call the item when
          it's picked up.  defaults to "Treasure Item" (SA: temp)
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"item_treasure",
           ...
           {"models/powerups/treasure/goldbar.md3", 0, 0, 0, 0},
          ...
          */
          ...
          /*QUAKED item_health (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN
          - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"item_health",
           "sound/pickup/health/health_pickup.wav",
           {"models/powerups/health/health_m.md3", 0, 0, 0, 0},
           "icons/iconh_med",
           NULL, // ammo icon
           "Med Health",
           25,
          ...
          */
          {"item_health_large",
           "sound/pickup/health/health_pickup.wav",
           {"models/powerups/health/health_l.md3", 0, 0, 0, 0},
           "icons/iconh_large",
           NULL, // ammo icon
           "Large Health",
           50,
          ...
          /*QUAKED item_health_turkey (.3 .3 1) (-16 -16 -16) (16 16 16)
          SUSPENDED SPIN - RESPAWN multi-stage health item. gives amount on
          first use based on skill: skill 1: 50 skill 2: 50 skill 3: 50 skill 4:
          40 skill 5: 30
          ...
          */
          {
              ...
              "",
              {45, 35, 25,
               15} // amount given in first stage based on gameskill level
          },

          /*QUAKED item_health_breadandmeat (.3 .3 1) (-16 -16 -16) (16 16 16)
          SUSPENDED SPIN - RESPAWN multi-stage health item. gives amount on
          first use based on skill: skill 1: 30 skill 2: 30 skill 3: 30 skill 4:
          20 skill 5: 10
          ...
          */
          ...
          /*QUAKED item_health_wall_box (.3 .3 1) (-16 -16 -16) (16 16 16)
          SUSPENDED - - RESPAWN single use health with dual state model. please
          set the suspended flag to keep it from falling on the ground defaults
          to 50 pts health
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"item_health_wall_box",
           ...
           {"models/powerups/health/health_wallbox2.md3",
            "models/powerups/health/health_wallbox1.md3", 0, 0, 0},
           "icons/iconh_wall",
           NULL, // ammo icon
           "Health",
           25,
          ...
          - - RESPAWN defaults to 50 pts health you will probably want to check
          the 'suspended' box to keep it from falling to the ground
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          model="models/powerups/health/health_w.md3"
          */
          {"item_health_wall",
           "sound/pickup/health/health_pickup.wav",
           {"models/powerups/health/health_w.md3", 0, 0, 0, 0},
           "icons/iconh_wall",
           NULL, // ammo icon
           "Health",
           25,
          ...
          /*QUAKED item_stamina_stein (.3 .3 1) (-16 -16 -16) (16 16 16)
          SUSPENDED SPIN - RESPAWN defaults to 30 sec stamina boost
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          ...
          {"item_stamina_stein",
           ...
           {"models/powerups/instant/stamina_stein.md3", 0, 0, 0, 0},
           "icons/icons_stein",
           NULL, // ammo icon
           "Stamina",
           25,
          ...
          /*QUAKED item_stamina_brandy (.3 .3 1) (-16 -16 -16) (16 16 16)
          SUSPENDED SPIN - RESPAWN defaults to 30 sec stamina boost
          ...
          */
          ...
          {"item_stamina_brandy",
           ...
           {"models/powerups/instant/stamina_brandy2.md3",
            "models/powerups/instant/stamina_brandy1.md3", 0, 0, 0},
           "icons/icons_brandy",
           NULL, // ammo icon
           "Stamina",
           25,
          ...
          */
          {"item_armor_body",
           "sound/pickup/armor/body_pickup.wav",
           {"models/powerups/armor/armor_body1.md3", 0, 0, 0, 0},
           "icons/iconr_body",
           NULL, // ammo icon
           "Flak Jacket",
           75,
          ...
          /*QUAKED item_armor_body_hang (.3 .3 1) (-16 -16 -16) (16 16 16)
          SUSPENDED - - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"item_armor_body_hang",
           "sound/pickup/armor/body_pickup.wav",
           {"models/powerups/armor/armor_body2.md3", 0, 0, 0, 0},
           "icons/iconr_bodyh",
           NULL, // ammo icon
           "Flak Jacket",
           75,
          ...
          */
          {"item_armor_head",
           ...
           {"models/powerups/armor/armor_head1.md3", 0, 0, 0, 0},
           "icons/iconr_head",
           NULL, // ammo icon
           "Armored Helmet",
           25,
          ...
          */
          {"weapon_gauntlet",
           ...
           {"models/weapons2/gauntlet/gauntlet.md3", 0, 0, 0, 0},
           "",            // icon
          ...
          */
          {"weapon_knife",
           ...
           {"models/weapons2/knife/knife.md3",
            ...
            "models/weapons2/knife/pu_knife.md3", 0, 0},
          ...
          /* weapon_knife2 (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN -
          RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"weapon_luger",
           ...
           {"models/weapons2/luger/luger.md3",
            ...
            "models/weapons2/luger/pu_luger.md3", 0, 0},
          ...
          /*QUAKED weapon_mauserRifle (.3 .3 1) (-16 -16 -16) (16 16 16)
          SUSPENDED SPIN - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"weapon_mauserRifle",
           ...
           {"models/weapons2/mauser/mauser.md3",
            ...
            "models/weapons2/mauser/pu_mauser.md3", 0, 0},
          ...
          */
          {"weapon_thompson",
           ...
           {"models/weapons2/thompson/thompson.md3",
            ...
            "models/weapons2/thompson/pu_thompson.md3", 0, 0},
          ...
          /*QUAKED weapon_sten (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN
          - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"weapon_sten",
           "sound/misc/w_pkup.wav",
           {"models/weapons2/sten/sten.md3", "models/weapons2/sten/v_sten.md3",
            "models/weapons2/sten/pu_sten.md3", 0, 0},
          ...
          */
          {
              ...
              {"models/weapons2/colt2/colt2.md3",
               ...
               "models/weapons2/colt2/pu_colt2.md3", 0, 0},
          ...
          /*QUAKED weapon_colt (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN
          - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"weapon_colt",
           "sound/misc/w_pkup.wav",
           {"models/weapons2/colt/colt.md3", "models/weapons2/colt/v_colt.md3",
            "models/weapons2/colt/pu_colt.md3", 0, 0},
          ...
          // (SA) snooper is the parent, so 'garand' is no longer available as a
          // stand-alone weap w/ an optional scope
          /*
          ...
          */
          {"NOT_weapon_garandRifle", //----(SA)	modified so it can no longer be
                                     //given individually
           "sound/misc/w_pkup.wav",
           {"models/weapons2/garand/garand.md3",
            "models/weapons2/garand/v_garand.md3",
            "models/weapons2/garand/pu_garand.md3", 0, 0},

           "icons/iconw_garand_1", // icon
           "icons/ammo3",          // ammo icon
           "",                     // pickup			//----(SA)	modified so it can no
                                   // longer be given individually
           50,
           IT_WEAPON,
           WP_GARAND,
           WP_GARAND,
          ...
          /*QUAKED weapon_mp40 (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN
          - RESPAWN "stand" values: no value:	laying in a default position on
          it's side (default)
                  2:			upright, barrel pointing up, slightly
          angled (rack mount)
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"weapon_mp40",
           "sound/misc/w_pkup.wav",
           {"models/weapons2/mp40/mp40.md3", "models/weapons2/mp40/v_mp40.md3",
            "models/weapons2/mp40/pu_mp40.md3", 0, 0},
          ...
          /*QUAKED weapon_fg42 (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN
          - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"weapon_fg42",
           ...
           {"models/weapons2/fg42/fg42.md3", "models/weapons2/fg42/v_fg42.md3",
            "models/weapons2/fg42/pu_fg42.md3", 0, 0},
          ...
          /* weapon_bar (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN -
          RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          ...
          /*QUAKED weapon_silencer (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED
          SPIN - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {
              "weapon_silencer",
              "sound/misc/w_pkup.wav",
              {"models/weapons2/silencer/silencer.md3", //----(SA)	changed
                                                        //10/25
               "models/weapons2/silencer/v_silencer.md3",
               "models/weapons2/silencer/pu_silencer.md3", 0, 0},
          ...
          /*QUAKED weapon_panzerfaust (.3 .3 1) (-16 -16 -16) (16 16 16)
          SUSPENDED SPIN - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"weapon_panzerfaust",
           ...
           {"models/weapons2/panzerfaust/pf.md3",
            ...
            "models/weapons2/panzerfaust/pu_pf.md3", 0, 0},
          ...
          /* weapon_rocketlauncher (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED
          SPIN - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          ...
          /* weapon_proxlauncher (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED
          SPIN - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          ...
          //----(SA)	removed the quaked for this.  we don't actually have a
          //grenade launcher as such.  It's given implicitly 			by virtue of
          //getting grenade ammo.  So we don't need to have them in maps
          /*
          ...
          */
          {"weapon_grenadelauncher",
           ...
           {"models/weapons2/grenade/grenade.md3",
            ...
            "models/weapons2/grenade/pu_grenade.md3", 0, 0},
           ...
           "sound/weapons/grenade/hgrenb2a.wav", // sounds
           {0, 0, 0, 0}},
          ...
          */
          {"weapon_grenadepineapple",
           ...
           {"models/weapons2/grenade/pineapple.md3",
            ...
            "models/weapons2/grenade/pu_pineapple.md3", 0, 0},
          ...
          weapon_grenadesmoke
          */
          /*	// just commented out to remove the registration errors in SP
          (we register every weapon in every map in SP)
                  {
                          "weapon_grenadesmoke",
                          "sound/misc/w_pkup.wav",
                          {
          "models/multiplayer/smokegrenade/smokegrenade.md3",
                          ...
                          "icons/ammo2",	// ammo icon
                          "smokeGrenade",				//
          pickup 50, IT_WEAPON, WP_GRENADE_SMOKE, WP_GRENADE_SMOKE,
                          WP_GRENADE_SMOKE,
                          "",						//
          precache "sound/weapons/grenade/hgrenb1a.wav
          ...
          */
          {"weapon_dynamite",
           ...
           {"models/weapons2/dynamite/dynamite.md3",
            ...
            "models/weapons2/dynamite/pu_dynamite.md3", 0, 0},
          ...
          */
          {"weapon_venom",
           ...
           {"models/weapons2/venom/venom.md3",
            ...
            "models/weapons2/venom/pu_venom.md3", 0, 0},
          ...
          /* weapon_venom_shotgun (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED
          SPIN - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          model="models/weapons2/venom/pu_venom.md3"
          */
          ...
          */
          ...
          /* weapon_cross(.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN -
          RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"weapon_flamethrower",
           ...
           {"models/weapons2/flamethrower/flamethrower.md3",
            ...
            "models/weapons2/flamethrower/pu_flamethrower.md3", 0, 0},
          ...
          /*QUAKED weapon_tesla (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED
          SPIN - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"weapon_tesla",
           ...
           {"models/weapons2/tesla/tesla.md3",
            ...
            "models/weapons2/tesla/pu_tesla.md3", 0, 0},
          ...
          /* weapon_speargun (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN -
          RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          ...
          /* weapon_speargun_c02 (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED
          SPIN - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          model="models/weapons2/speargun/pu_speargun.md3"
          */
          ...
          */
          ...
          /*QUAKED weapon_sniperScope (.3 .3 1) (-16 -16 -16) (16 16 16)
          SUSPENDED SPIN - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          ...
          */
          {"weapon_sniperScope",
           ...
           {"models/weapons2/mauser/mauser.md3",
            ...
            "models/weapons2/mauser/pu_mauser_scope.md3", 0, 0},
          ...
          /*QUAKED weapon_snooperrifle (.3 .3 1) (-16 -16 -16) (16 16 16)
          SUSPENDED SPIN - RESPAWN
          -------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
          model="models/weapons2/garand/garand.md3"
          */
          ...
          */
          ...
          SPIN - RESPAWN used by: Luger pistol, MP40 machinegun
          ...
          */
          {"ammo_9mm_small",
           ...
           {"models/powerups/ammo/am9mm_s.md3", 0, 0, 0, 0},
           "icons/iconw_luger_1", // icon
           NULL,                  // ammo icon
           "9mm Rounds",          // pickup
           30,
          ...
          */
          {"ammo_9mm",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/am9mm_m.md3", 0, 0, 0, 0},
           "icons/iconw_luger_1", // icon
           NULL,                  // ammo icon
          ...
          */
          {"ammo_9mm_large",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/am9mm_l.md3", 0, 0, 0, 0},
           "icons/iconw_luger_1", // icon
           NULL,                  // ammo icon
           "9mm Box",             // pickup
           100,
          ...
          SPIN - RESPAWN used by: Thompson, Colt
          ...
          */
          {"ammo_45cal_small",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/am45cal_s.md3", 0, 0, 0, 0},
           "icons/iconw_luger_1", // icon
           NULL,                  // ammo icon
           ".45cal Rounds",       // pickup
           20,
          ...
          */
          {"ammo_45cal",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/am45cal_m.md3", 0, 0, 0, 0},
           "icons/iconw_luger_1", // icon
           NULL,                  // ammo icon
          ...
          */
          {"ammo_45cal_large",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/am45cal_l.md3", 0, 0, 0, 0},
           "icons/iconw_luger_1", // icon
           NULL,                  // ammo icon
           ".45cal Box",          // pickup
           100,
          ...
          SPIN - RESPAWN used by: Mauser rifle, FG42
          ...
          */
          {"ammo_792mm_small",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/am792mm_s.md3", 0, 0, 0, 0},
           ...
           "", // sounds
           {16, 12, 8, 8}},
          /*QUAKED ammo_792mm (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN
          - RESPAWN used by: Mauser rifle, FG42
          ...
          */
          {"ammo_792mm",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/am792mm_m.md3", 0, 0, 0, 0},
           "icons/icona_machinegun", // icon
           NULL,                     // ammo icon
          ...
          */
          {"ammo_792mm_large",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/am792mm_l.md3", 0, 0, 0, 0},
           "icons/icona_machinegun", // icon
           NULL,                     // ammo icon
           "7.92mm Box",             // pickup
           50,
          ...
          SPIN - RESPAWN used by: Garand rifle
          ...
          */
          {"ammo_30cal_small",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/am30cal_s.md3", 0, 0, 0, 0},
           "icons/icona_machinegun", // icon
           NULL,                     // ammo icon
           ".30cal Rounds",          // pickup
           50,
          ...
          */
          {"ammo_30cal",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/am30cal_m.md3", 0, 0, 0, 0},
           "icons/icona_machinegun", // icon
           NULL,                     // ammo icon
          ...
          */
          {"ammo_30cal_large",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/am30cal_l.md3", 0, 0, 0, 0},
           "icons/icona_machinegun", // icon
           NULL,                     // ammo icon
           ".30cal Box",             // pickup
           50,
          ...
          /*QUAKED ammo_127mm (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN
          - RESPAWN used by: Venom gun
          ...
          */
          {"ammo_127mm",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/am127mm.md3", 0, 0, 0, 0},
           "icons/icona_machinegun", // icon
           NULL,                     // ammo icon
           "12.7mm",                 // pickup
           100,
          ...
          */
          {"ammo_grenades",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/amgren_bag.md3", 0, 0, 0, 0},
          ...
          /*QUAKED ammo_grenades_american (.3 .3 1) (-16 -16 -16) (16 16 16)
          SUSPENDED SPIN - RESPAWN
          ...
          */
          {"ammo_grenades_american",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/amgrenus_bag.md3", 0, 0, 0, 0},
          ...
          */
          {"ammo_dynamite",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/dynamite.md3", 0, 0, 0, 0},
          ...
          /*QUAKED ammo_cell (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN -
          RESPAWN used by: Tesla
          ...
          */
          {"ammo_cell",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/amcell.md3", 0, 0, 0, 0},
          ...
          /*QUAKED ammo_fuel (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN -
          RESPAWN used by: Flamethrower
          ...
          */
          {"ammo_fuel",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/amfuel.md3", 0, 0, 0, 0},
          ...
          /* ammo_speargun (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN -
          RESPAWN used by: Speargun
          ...
          */
          ...
          /* ammo_speargun_co2 (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN
          - RESPAWN CO2 tipped speargun bolts
          ...
          */
          ...
          SPIN - RESPAWN used by: German Panzerfaust
          ...
          */
          {"ammo_panzerfaust",
           "sound/misc/am_pkup.wav",
           {"models/powerups/ammo/ampf.md3", 0, 0, 0, 0},
          ...
          /* ammo_rockets (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN -
          RESPAWN used by: Allied Rocket Launcher (bazooka)
          ...
          */
          ...
          /* ammo_charges (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN -
          RESPAWN used by: Cross of Coronado
          ...
          */
          ...
          /* holdable_medkit (.3 .3 1) (-16 -16 -16) (16 16 16) SUSPENDED SPIN -
          RESPAWN
          ...
          /*
                  {
                          ...
                          0,
                          "",				// precache
                          "sound/pickup/holdable/use_medkit.wav",	//
             sounds {0,0,0,0}
                  },
          */
          ...
          */
          {"holdable_wine",
           ...
           {"models/powerups/holdable/wine.md3", 0, 0, 0, 0},
           "icons/wine",          // icon
           NULL,                  // ammo icon
          ...
          /* holdable_skull (.3 .3 1) (-8 -8 -8) (8 8 8) SUSPENDED SPIN -
          RESPAWN Skull of Invulnerability Protection from all attacks
          ...
          /*
                  {
                          ...
                          "icons/skull",					//
             icon NULL,							// ammo
             icon "Skull of Invulnerability",		// pickup 1,
                          IT_HOLDABLE,
                          HI_SKULL,
                          0,
                          0,
                          "",								//
             precache "sound/pickup/holdable/use_skull.wav",	// sounds
                          {0,0,0,0}
                  },
          */

          /* holdable_p_water (.3 .3 1) (-8 -8 -8) (8 8 8) SUSPENDED SPIN -
          RESPAWN Protection from drowning for n seconds "time" (in seconds) How
          much extra underwater time is given
          ...
          /*
                  {
                          ...
                          "icons/water",					//
             icon NULL,							// ammo
             icon "Breather",					// pickup 1,
                          IT_HOLDABLE,
                          HI_WATER,
                          0,
                          0,
                          "",								//
             precache "sound/pickup/holdable/use_water.wav",	// sounds
                          {0,0,0,0}
                  },
          */

          /* holdable_p_elec (.3 .3 1) (-8 -8 -8) (8 8 8) SUSPENDED SPIN -
          RESPAWN Protection from electric attacks Absorbs "dmg" points of
          electric damage
          ...
          /*
                  {
                          ...
                          "icons/elec",					// icon
                          NULL,							// ammo
             icon "Electric Protection",			// pickup 1,
                          IT_HOLDABLE,
                          HI_ELECTRIC,
                          0,
                          0,
                          "",								//
             precache "sound/pickup/holdable/use_elec.wav",	// sounds
                          {0,0,0,0}
                  },
          */

          /* holdable_p_fire (.3 .3 1) (-8 -8 -8) (8 8 8) SUSPENDED SPIN -
          RESPAWN Protection from fire attacks Absorbs "dmg" points of fire
          damage
          ...
          /*
                  {
                          ...
                          "icons/fire",					// icon
                          NULL,							// ammo
             icon "Fire Protection",				// pickup 1,
                          IT_HOLDABLE,
                          HI_FIRE,
                          0,
                          0,
                          "",								//
             precache "sound/pickup/holdable/use_fire.wav",	// sounds
                          {0,0,0,0}
                  },
          */

          /*QUAKED holdable_stamina(.3 .3 1) (-8 -8 -8) (8 8 8) SUSPENDED SPIN -
          RESPAWN Protection from fatigue Using the "sprint" key will not
          ...
          */
          {"holdable_stamina",
           ...
           {"models/powerups/holdable/stamina.md3", 0, 0, 0, 0},
           "icons/stamina", // icon
           NULL,            // ammo icon
          ...
          */
          {"holdable_book1",
           ...
           {"models/powerups/holdable/venom_book.md3", 0, 0, 0, 0},
          ...
          */
          {"holdable_book2",
           ...
           {"models/powerups/holdable/paranormal_book.md3", 0, 0, 0, 0},
          ...
          */
          {"holdable_book3",
           ...
           {"models/powerups/holdable/zemphr_book.md3", 0, 0, 0, 0},
          ...
          */
          /*
             ...
             icon "11",					// pickup 1,
                          ...
                          0,
                          "",								//
             precache "sound/pickup/holdable/use_11.wav",	// sounds
                          {0,0,0,0}
                  },
          */
          ...
          */
          /*
             ...
             icon "12",					// pickup 1,
                          ...
                          0,
                          "",								//
             precache "sound/pickup/holdable/use_12.wav",	// sounds
                          {0,0,0,0}
                  },
          */
          ...
          */
          /*
             ...
             icon "13",					// pickup 1,
                          ...
                          0,
                          "",								//
             precache "sound/pickup/holdable/use_13.wav",	// sounds
                          {0,0,0,0}
                  },
          */
          ...
          */
          /*
             ...
             icon "14",					// pickup 1,
                          ...
                          0,
                          "",								//
             precache "sound/pickup/holdable/use_14.wav",	// sounds
                          {0,0,0,0}
                  },
          */
          ...
          icon "15",					// pickup 1,
                          ...
                          0,
                          "",								//
          precache "sound/pickup/holdable/use_15.wav",	// sounds {0,0,0,0}
                  },
          ...
          */
          {"team_CTF_redflag",
           ...
           {"models/flags/r_flag.md3", 0, 0, 0, 0},
           ...
           0,
           "", // precache
           "sound/teamplay/flagcap_red.wav sound/teamplay/flagtk_red.wav "
           "sound/teamplay/flagret_red.wav", // sounds
           {0, 0, 0, 0}},
          ...
          */
          {"team_CTF_blueflag",
           ...
           {"models/flags/b_flag.md3", 0, 0, 0, 0},
           ...
           0,
           "", // precache
           "sound/teamplay/flagcap_blu.wav sound/teamplay/flagtk_blu.wav "
           "sound/teamplay/flagret_blu.wav", // sounds
           {0, 0, 0, 0}},
          ...
          /*
                  {
                          ...
                          0,
                          "",						//
             precache "models/keys/key.wav",	// sounds {0,0,0,0}
                  },
          */
          ...
          */
          ...
          /* key_satchelcharge5 (1 1 0) (-8 -8 -8) (8 8 8) SUSPENDED SPIN -
          RESPAWN key 5
          ...
          */
          {"key_binocs",
           ...
           {"models/powerups/keys/binoculars.md3", 0, 0, 0, 0},
           "icons/binocs", // icon
           NULL,           // ammo icon
           "Binoculars",   // pickup
           0,
...
==============
BG_PlayerSeesItem
        Try to quickly determine if an item should be highlighted as per the
current cg_drawCrosshairPickups.integer value. pvs check should have already
been done by the time we get in here, so we shouldn't have to check
==============
*/
...
qboolean BG_PlayerSeesItem(playerState_t *ps, entityState_t *item, int atTime)
{
   ...
   vorigin[2] += ps->viewheight;			// get the view loc up to the
viewheight
   eorigin[2] += 16;						// and subtract the item's
offset (that is used to place it on the ground) VectorSubtract(vorigin, eorigin,
dir);

   dist = VectorNormalize(dir);			// dir is now the direction from
the item to the player

   if(dist > 255)
           return qfalse;						// only run the remaining
stuff on items that are close enough
   ...
   foo = -0.94f - (dist/255.0f) * 0.057f;	// (ranging from -0.94 to -0.997)
(it happened to be a pretty good range)
...
//----(SA)	check for mp
    ...
    if (multiplayer) {
      ...
      if (COM_BitCheck(ps->weapons, item->giTag)) { // you have the weap
        if (isClipOnly(item->giTag)) {
          if (ps->ammoclip[item->giAmmoIndex] >=
              ammoTable[item->giAmmoIndex].maxclip) {
            return qfalse;
          }
        } else {
          if (ps->ammo[item->giAmmoIndex] >=
              ammoTable[item->giAmmoIndex]
                  .maxammo) { // you are loaded with the ammo
            return qfalse;
          }
        }
      }
  ...
  case IT_TEAM: // team items, such as flags
    ...
    // we need to know this because we can pick up our dropped flag (and return
    // it) but we can't pick up our flag at base
