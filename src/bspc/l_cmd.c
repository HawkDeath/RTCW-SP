...
int Q_stricmp(char *s1, char *s2) { return Q_strncasecmp(s1, s2, 99999); }
...
unsigned short BigUnsignedShort(unsigned short l) { return l; }
...
unsigned BigUnsigned(unsigned l) { return l; }
#endif
...
unsigned short LittleUnsignedShort(unsigned short l) { return l; }
...
unsigned LittleUnsigned(unsigned l) { return l; }
#endif
