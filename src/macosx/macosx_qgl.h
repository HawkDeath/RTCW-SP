...
// This has to be done to avoid infinite recursion between our glGetError
// wrapper and QGLCheckError()
static inline GLenum _glGetError(void) { return glGetError(); }
...
// *residences);
static inline GLboolean qglAreTexturesResident(GLsizei n,
  ...
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glAreTexturesResident(n=%ld, textures=%p, residences=%p)\n", n,
            textures, residences);
  }
#endif
...
static inline void qglBitmap(GLsizei width, GLsizei height, GLfloat xorig,
                             GLfloat yorig, GLfloat xmove, GLfloat ymove,
                             const GLubyte *bitmap) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glBitmap(width=%ld, height=%ld, xorig=%f, yorig=%f, xmove=%f, "
            "ymove=%f, bitmap=%p)\n",
...
static inline void qglClearAccum(GLfloat red, GLfloat green, GLfloat blue,
                                 GLfloat alpha) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glClearAccum(red=%f, green=%f, blue=%f, alpha=%f)\n", red, green,
            blue, alpha);
  }
#endif
...
// alpha);
static inline void qglClearColor(GLclampf red, GLclampf green, GLclampf blue,
                                 GLclampf alpha) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
...
static inline void qglColor4b(GLbyte red, GLbyte green, GLbyte blue,
                              GLbyte alpha) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglColor4d(GLdouble red, GLdouble green, GLdouble blue,
                              GLdouble alpha) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglColor4f(GLfloat red, GLfloat green, GLfloat blue,
                              GLfloat alpha) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglColor4i(GLint red, GLint green, GLint blue, GLint alpha) {
  ...
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glColor4i(red=%ld, green=%ld, blue=%ld, alpha=%ld)\n", red, green,
            blue, alpha);
  }
#endif
...
static inline void qglColor4s(GLshort red, GLshort green, GLshort blue,
                              GLshort alpha) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglColor4ub(GLubyte red, GLubyte green, GLubyte blue,
                               GLubyte alpha) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglColor4ui(GLuint red, GLuint green, GLuint blue,
                               GLuint alpha) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glColor4ui(red=%lu, green=%lu, blue=%lu, alpha=%lu)\n", red, green,
            blue, alpha);
  }
#endif
...
// void glColor4us (GLushort red, GLushort green, GLushort blue, GLushort
// alpha);
static inline void qglColor4us(GLushort red, GLushort green, GLushort blue,
                               GLushort alpha) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
// alpha);
static inline void qglColorMask(GLboolean red, GLboolean green, GLboolean blue,
                                GLboolean alpha) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
...
// *pointer);
static inline void qglColorPointer(GLint size, GLenum type, GLsizei stride,
                                   const GLvoid *pointer) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glColorPointer(size=%ld, type=%lu, stride=%ld, pointer=%p)\n",
...
// type);
static inline void qglCopyPixels(GLint x, GLint y, GLsizei width,
                                 GLsizei height, GLenum type) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glCopyPixels(x=%ld, y=%ld, width=%ld, height=%ld, type=%lu)\n", x,
            y, width, height, type);
  }
#endif
...
static inline void qglCopyTexImage1D(GLenum target, GLint level,
                                     GLenum internalFormat, GLint x, GLint y,
                                     GLsizei width, GLint border) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glCopyTexImage1D(target=%lu, level=%ld, internalFormat=%lu, "
            "x=%ld, y=%ld, width=%ld, border=%ld)\n",
...
static inline void qglCopyTexImage2D(GLenum target, GLint level,
                                     GLenum internalFormat, GLint x, GLint y,
  ...
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glCopyTexImage2D(target=%lu, level=%ld, internalFormat=%lu, "
...
static inline void qglCopyTexSubImage1D(GLenum target, GLint level,
                                        GLint xoffset, GLint x, GLint y,
                                        GLsizei width) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glCopyTexSubImage1D(target=%lu, level=%ld, xoffset=%ld, x=%ld, "
            "y=%ld, width=%ld)\n",
...
static inline void qglCopyTexSubImage2D(GLenum target, GLint level,
  ...
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glCopyTexSubImage2D(target=%lu, level=%ld, xoffset=%ld, "
            "yoffset=%ld, x=%ld, y=%ld, width=%ld, height=%ld)\n",
...
// *indices);
static inline void qglDrawElements(GLenum mode, GLsizei count, GLenum type,
                                   const GLvoid *indices) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glDrawElements(mode=%lu, count=%ld, type=%lu, indices=%p)\n", mode,
            count, type, indices);
  }
#endif
...
// const GLvoid *pixels);
static inline void qglDrawPixels(GLsizei width, GLsizei height, GLenum format,
                                 GLenum type, const GLvoid *pixels) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glDrawPixels(width=%ld, height=%ld, format=%lu, type=%lu, "
            "pixels=%p)\n",
...
static inline void qglEvalMesh2(GLenum mode, GLint i1, GLint i2, GLint j1,
                                GLint j2) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glEvalMesh2(mode=%lu, i1=%ld, i2=%ld, j1=%ld, j2=%ld)\n", mode, i1,
            i2, j1, j2);
  }
#endif
...
static inline void qglFeedbackBuffer(GLsizei size, GLenum type,
                                     GLfloat *buffer) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglFrustum(GLdouble left, GLdouble right, GLdouble bottom,
                              GLdouble top, GLdouble zNear, GLdouble zFar) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(
        QGLDebugFile(),
        "glFrustum(left=%f, right=%f, bottom=%f, top=%f, zNear=%f, zFar=%f)\n",
...
static inline void qglGetMaterialfv(GLenum face, GLenum pname,
                                    GLfloat *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglGetTexEnvfv(GLenum target, GLenum pname,
                                  GLfloat *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglGetTexGendv(GLenum coord, GLenum pname,
                                  GLdouble *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
// GLvoid *pixels);
static inline void qglGetTexImage(GLenum target, GLint level, GLenum format,
                                  GLenum type, GLvoid *pixels) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glGetTexImage(target=%lu, level=%ld, format=%lu, type=%lu, "
            "pixels=%p)\n",
...
// GLfloat *params);
static inline void qglGetTexLevelParameterfv(GLenum target, GLint level,
                                             GLenum pname, GLfloat *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glGetTexLevelParameterfv(target=%lu, level=%ld, pname=%lu, "
            "params=%p)\n",
...
// GLint *params);
static inline void qglGetTexLevelParameteriv(GLenum target, GLint level,
                                             GLenum pname, GLint *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glGetTexLevelParameteriv(target=%lu, level=%ld, pname=%lu, "
            "params=%p)\n",
            target, level, pname, params);
  }
#endif
...
static inline void qglGetTexParameterfv(GLenum target, GLenum pname,
                                        GLfloat *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glGetTexParameterfv(target=%lu, pname=%lu, params=%p)\n", target,
            pname, params);
  }
#endif
...
static inline void qglGetTexParameteriv(GLenum target, GLenum pname,
                                        GLint *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glGetTexParameteriv(target=%lu, pname=%lu, params=%p)\n", target,
            pname, params);
  }
#endif
...
static inline void qglIndexPointer(GLenum type, GLsizei stride,
                                   const GLvoid *pointer) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glIndexPointer(type=%lu, stride=%ld, pointer=%p)\n", type, stride,
            pointer);
  }
#endif
...
// void glInterleavedArrays (GLenum format, GLsizei stride, const GLvoid
// *pointer);
static inline void qglInterleavedArrays(GLenum format, GLsizei stride,
                                        const GLvoid *pointer) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glInterleavedArrays(format=%lu, stride=%ld, pointer=%p)\n", format,
            stride, pointer);
  }
#endif
...
static inline void qglLightfv(GLenum light, GLenum pname,
...
// void glMap1d (GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint
// order, const GLdouble *points);
static inline void qglMap1d(GLenum target, GLdouble u1, GLdouble u2,
                            GLint stride, GLint order, const GLdouble *points) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(
        QGLDebugFile(),
        "glMap1d(target=%lu, u1=%f, u2=%f, stride=%ld, order=%ld, points=%p)\n",
...
static inline void qglMap1f(GLenum target, GLfloat u1, GLfloat u2, GLint stride,
                            GLint order, const GLfloat *points) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(
        QGLDebugFile(),
        "glMap1f(target=%lu, u1=%f, u2=%f, stride=%ld, order=%ld, points=%p)\n",
        target, u1, u2, stride, order, points);
  }
#endif
...
// void glMap2d (GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint
// uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble
// *points);
static inline void qglMap2d(GLenum target, GLdouble u1, GLdouble u2,
  ...
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glMap2d(target=%lu, u1=%f, u2=%f, ustride=%ld, uorder=%ld, v1=%f, "
            "v2=%f, vstride=%ld, vorder=%ld, points=%p)\n",
...
// void glMap2f (GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint
// uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat
// *points);
static inline void qglMap2f(GLenum target, GLfloat u1, GLfloat u2,
  ...
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glMap2f(target=%lu, u1=%f, u2=%f, ustride=%ld, uorder=%ld, v1=%f, "
            "v2=%f, vstride=%ld, vorder=%ld, points=%p)\n",
            target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
  }
#endif
...
// GLdouble v2);
static inline void qglMapGrid2d(GLint un, GLdouble u1, GLdouble u2, GLint vn,
                                GLdouble v1, GLdouble v2) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glMapGrid2d(un=%ld, u1=%f, u2=%f, vn=%ld, v1=%f, v2=%f)\n", un, u1,
            u2, vn, v1, v2);
  }
#endif
...
// GLfloat v2);
static inline void qglMapGrid2f(GLint un, GLfloat u1, GLfloat u2, GLint vn,
                                GLfloat v1, GLfloat v2) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glMapGrid2f(un=%ld, u1=%f, u2=%f, vn=%ld, v1=%f, v2=%f)\n", un, u1,
            u2, vn, v1, v2);
  }
#endif
...
static inline void qglMaterialfv(GLenum face, GLenum pname,
                                 const GLfloat *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglMaterialiv(GLenum face, GLenum pname,
                                 const GLint *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglNormalPointer(GLenum type, GLsizei stride,
                                    const GLvoid *pointer) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glNormalPointer(type=%lu, stride=%ld, pointer=%p)\n", type, stride,
            pointer);
  }
#endif
...
// GLdouble zNear, GLdouble zFar);
static inline void qglOrtho(GLdouble left, GLdouble right, GLdouble bottom,
                            GLdouble top, GLdouble zNear, GLdouble zFar) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(
        QGLDebugFile(),
        "glOrtho(left=%f, right=%f, bottom=%f, top=%f, zNear=%f, zFar=%f)\n",
        left, right, bottom, top, zNear, zFar);
  }
#endif
...
static inline void qglPixelMapfv(GLenum map, GLsizei mapsize,
...
static inline void qglPixelMapuiv(GLenum map, GLsizei mapsize,
                                  const GLuint *values) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglPixelMapusv(GLenum map, GLsizei mapsize,
...
// void glPrioritizeTextures (GLsizei n, const GLuint *textures, const GLclampf
// *priorities);
static inline void qglPrioritizeTextures(GLsizei n, const GLuint *textures,
                                         const GLclampf *priorities) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glPrioritizeTextures(n=%ld, textures=%p, priorities=%p)\n", n,
            textures, priorities);
  }
#endif
...
static inline void qglRasterPos4d(GLdouble x, GLdouble y, GLdouble z,
                                  GLdouble w) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglReadPixels(GLint x, GLint y, GLsizei width,
                                 GLsizei height, GLenum format, GLenum type,
                                 GLvoid *pixels) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glReadPixels(x=%ld, y=%ld, width=%ld, height=%ld, format=%lu, "
            "type=%lu, pixels=%p)\n",
...
static inline void qglRectd(GLdouble x1, GLdouble y1, GLdouble x2,
                            GLdouble y2) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglRotated(GLdouble angle, GLdouble x, GLdouble y,
                              GLdouble z) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglTexCoord4d(GLdouble s, GLdouble t, GLdouble r,
                                 GLdouble q) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
// *pointer);
static inline void qglTexCoordPointer(GLint size, GLenum type, GLsizei stride,
                                      const GLvoid *pointer) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glTexCoordPointer(size=%ld, type=%lu, stride=%ld, pointer=%p)\n",
            size, type, stride, pointer);
  }
#endif
...
static inline void qglTexEnvfv(GLenum target, GLenum pname,
                               const GLfloat *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglTexEnviv(GLenum target, GLenum pname,
                               const GLint *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglTexGendv(GLenum coord, GLenum pname,
...
static inline void qglTexGenfv(GLenum coord, GLenum pname,
                               const GLfloat *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglTexGeniv(GLenum coord, GLenum pname,
                               const GLint *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
static inline void qglTexImage1D(GLenum target, GLint level,
  ...
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glTexImage1D(target=%lu, level=%ld, internalformat=%ld, "
            "width=%ld, border=%ld, format=%lu, type=%lu, pixels=%p)\n",
...
// *pixels);
static inline void qglTexImage2D(GLenum target, GLint level,
                                 GLint internalformat, GLsizei width,
  ...
  if (QGLLogGLCalls) {
    fprintf(
        QGLDebugFile(),
        "glTexImage2D(target=%lu, level=%ld, internalformat=%ld, width=%ld, "
        "height=%ld, border=%ld, format=%lu, type=%lu, pixels=%p)\n",
...
static inline void qglTexParameterf(GLenum target, GLenum pname,
                                    GLfloat param) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glTexParameterf(target=%lu, pname=%lu, param=%f)\n", target, pname,
            param);
  }
#endif
...
static inline void qglTexParameterfv(GLenum target, GLenum pname,
                                     const GLfloat *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glTexParameterfv(target=%lu, pname=%lu, params=%p)\n", target,
            pname, params);
  }
#endif
...
static inline void qglTexParameteri(GLenum target, GLenum pname, GLint param) {
  ...
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glTexParameteri(target=%lu, pname=%lu, param=%ld)\n", target,
            pname, param);
  }
#endif
...
static inline void qglTexParameteriv(GLenum target, GLenum pname,
                                     const GLint *params) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glTexParameteriv(target=%lu, pname=%lu, params=%p)\n", target,
            pname, params);
  }
#endif
...
// void glTexSubImage1D (GLenum target, GLint level, GLint xoffset, GLsizei
// width, GLenum format, GLenum type, const GLvoid *pixels);
static inline void qglTexSubImage1D(GLenum target, GLint level, GLint xoffset,
                                    GLsizei width, GLenum format, GLenum type,
                                    const GLvoid *pixels) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glTexSubImage1D(target=%lu, level=%ld, xoffset=%ld, width=%ld, "
            "format=%lu, type=%lu, pixels=%p)\n",
...
// GLvoid *pixels);
static inline void qglTexSubImage2D(GLenum target, GLint level, GLint xoffset,
  ...
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glTexSubImage2D(target=%lu, level=%ld, xoffset=%ld, yoffset=%ld, "
            "width=%ld, height=%ld, format=%lu, type=%lu, pixels=%p)\n",
...
// *pointer);
static inline void qglVertexPointer(GLint size, GLenum type, GLsizei stride,
                                    const GLvoid *pointer) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
    fprintf(QGLDebugFile(),
            "glVertexPointer(size=%ld, type=%lu, stride=%ld, pointer=%p)\n",
            size, type, stride, pointer);
  }
#endif
...
static inline void qglViewport(GLint x, GLint y, GLsizei width,
                               GLsizei height) {
#if !defined(NDEBUG) && defined(QGL_LOG_GL_CALLS)
  if (QGLLogGLCalls) {
...
#define glGetTexLevelParameterfv                                               \
  CALL_THE_QGL_VERSION_OF_glGetTexLevelParameterfv
#define glGetTexLevelParameteriv                                               \
  CALL_THE_QGL_VERSION_OF_glGetTexLevelParameteriv
