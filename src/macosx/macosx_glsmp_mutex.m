...
// The command buffer returned might be NULL, indicating that the rendering
// thread should exit.
void *GLimp_RendererSleep(void) {
  ...
  {
    // Clear out any data we had and signal the main thread that we are no
    // longer busy
    smpData = NULL;
...
// Called from the main thread to wait until the rendering thread is done with
// the command buffer.
