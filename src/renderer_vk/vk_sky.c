...
static void DrawSkySideInner(struct image_s *image, const int mins[2],
                             const int maxs[2]) {
  int s, t;
...
void RB_DrawSun(void) {
 ...
 // qglDepthRange(1.0, 1.0);
  ...
  if (r_drawSun->integer > 1) { // draw flare effect
    ...
    //				If we decide to use the flare business I will /definatly/ improve
    //all this
