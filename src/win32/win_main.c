...
//----(SA)	from NERVE MP codebase (10/15/01)  (checkins at time of this
//file should be related)
/*
==================
Sys_StartProcess
==================
...
==============
*/
void Sys_Print(const char *msg) { Conbuf_AppendText(msg); }
...
==============
*/
void Sys_Mkdir(const char *path) { _mkdir(path); }
...
==============
*/
char *Sys_DefaultBasePath(void) { return Sys_Cwd(); }
...
void *Sys_InitializeCriticalSection() { return (void *)-1; }
