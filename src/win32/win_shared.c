...
static void CPUID(int func, unsigned regs[4]) {
  ...
  __asm mov eax, func __asm __emit 00fh __asm __emit 0a2h __asm mov regEAX,
...
int Sys_GetHighQualityCPU() { return (!IsP3() && !IsAthlon()) ? 0 : 1; }
...
char *Sys_DefaultInstallPath(void) { return Sys_Cwd(); }
