...
tokens
token_t *freetokens;					//free tokens from the
heap
*/
...
//								if no parm found with the
//given name -1 is returned
// Changes Globals:		-
//============================================================================
...
// Changes Globals:		-
//============================================================================
int PC_ExpandDefine(source_t *source, define_t *define, token_t **firsttoken,
                    token_t **lasttoken) {
