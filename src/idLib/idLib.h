...
template <class IndexType> class idFlags {
public:
  typedef unsigned int T;

  idFlags(void) { flag = 0; }
  idFlags(const char *debugnames);
  idFlags(const T val) { flag = val; }
...
template <class Type> class idHashTable {
private:
  struct hashnode_s {
    idStr key;
    Type value;
...
================
*/
template <class Type> inline idHashTable<Type>::~idHashTable() {
  Clear();
  delete[] m_heads;
}
...
================
*/
template <class Type> inline bool idHashTable<Type>::Remove(const char *key) {
  hashnode_s **head;
  hashnode_s *node;
  hashnode_s *prev;
  unsigned hash;
...
================
*/
template <class Type> inline void idHashTable<Type>::Clear(void) {
  unsigned i;
  hashnode_s *node;
  hashnode_s *next;
...
================
*/
template <class Type> inline void idHashTable<Type>::DeleteContents(void) {
  unsigned i;
  hashnode_s *node;
  hashnode_s *next;
...
================
*/
template <class Type> inline unsigned idHashTable<Type>::Num(void) const {
  return m_numentries;
}
